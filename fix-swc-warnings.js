...
function updateGitignore() {
  ...
  // Check for node_modules/.cache in gitignore
  if (!gitignoreContent.includes('node_modules/.cache')) {
    gitignoreContent += '\n# Node modules cache\nnode_modules/.cache/\n';
    fs.writeFileSync(gitignorePath, gitignoreContent);
    console.log('✅ Added node_modules/.cache to .gitignore');
  } else {
    console.log('⚠️ node_modules/.cache already in .gitignore');
  }
}
...
console.log('🚀 Please restart your Next.js application to apply changes'); 