...
Ứng dụng web được xây dựng với Next.js, TypeScript và Tailwind CSS.

## Tính năng

- 🔐 Xác thực người dùng với NextAuth và Google OAuth
- 🛡️ Bảo mật cao với các HTTP Security Headers
- 📱 Giao diện responsive với Tailwind CSS
- 🚀 Hiệu suất tối ưu với Next.js App Router
- 🌐 Hỗ trợ đa ngôn ngữ (Tiếng Việt và Tiếng Anh)
- 💳 Tích hợp thanh toán với Vietnam QR Pay
...
```bash
git clone https://github.com/yourusername/xlab_web.git
cd xlab_web
```
...
- **Sửa lỗi tự động**: `npm run lint:fix`
...
Dự án này tuân thủ các tiêu chuẩn bảo mật web hiện đại:
...
Dự án có thể được triển khai trên nhiều nền tảng:
