...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    'admin.notifications.settings.retentionDesc': 'Las notificaciones se eliminarán automáticamente después de esta cantidad de días',
    ...
    'admin.notifications.error': 'Se ha producido un error al crear la notificación',
    'admin.notifications.updateError': 'Se ha producido un error al actualizar la notificación',
    'admin.notifications.deleteError': 'Se ha producido un error al eliminar la notificación',
    'admin.notifications.connectionError': 'Se ha producido un error al conectar con el servidor',
    ...
    'home.aboutDesc2': 'Nuestra misión es brindar a los vietnamitas la oportunidad de acceder a herramientas para trabajar, estudiar y entretenerse a precios razonables y con calidad internacional.',
    ...
    'home.budgetOptions': 'Muchas opciones para todos los presupuestos',
    ...
    'home.faqDesc': 'Respuestas a las preguntas más comunes de los clientes sobre productos y servicios de XLab',
    'home.ctaTitle': '¿Listo para mejorar la productividad con XLab?',
    'home.ctaDesc': 'Ofrecemos varios precios con promociones especiales para clientes que compran en grandes cantidades. Cuanto más compras, mayor es el descuento. Nos comprometemos a brindarte las mejores soluciones al precio más razonable.',
    ...
    'about.innovationDesc': 'Innovación y mejora constante de la tecnología para aportar el mejor valor',
    ...
    'about.integrityDesc': 'Mantenemos la ética empresarial y la transparencia en todas las operaciones',
    'about.collaboration': 'Colaboración',
    'about.collaborationDesc': 'Construimos relaciones a largo plazo basadas en el respeto y la cooperación mutuamente beneficiosa',
    ...
    'contact.pageSubtitle': 'Contáctenos para obtener asesoramiento sobre la solución más adecuada para su empresa.',
    'contact.sendMessage': 'Envíenos un mensaje',
    'contact.yourName': 'Su nombre',
    'contact.yourEmail': 'Su correo electrónico',
    'contact.yourPhone': 'Teléfono',
    ...
    'contact.connectWithUs': 'Conéctese con nosotros',
    ...
    'contact.emailUs': 'Envíenos un correo',
    'contact.visitUs': 'Visítenos',
    'contact.workingHours': 'Horario de trabajo',
    'contact.faq': 'Preguntas frecuentes',
    'contact.faqSubtitle': 'Encuentre respuestas rápidas a las preguntas más comunes',
    'contact.followUs': 'Síganos en redes sociales',
    'contact.newsletterTitle': 'Suscríbase a nuestro boletín',
    'contact.newsletterSubtitle': 'Reciba las últimas noticias y actualizaciones',
    'contact.newsletterPlaceholder': 'Ingrese su correo electrónico',
    ...
    // Voucher widget
    'voucher.title': 'Código de descuento',
    'voucher.viewAll': 'Ver todos',
    'voucher.loading': 'Cargando...',
    'voucher.yourVouchers': 'Tus cupones',
    'voucher.expiryDate': 'Caducidad:',
    'voucher.usesLeft': 'Usos restantes: {count}',
    'voucher.minOrder': 'Pedido mínimo:',
    'voucher.noLimit': 'Sin límite',
    ...
    'footer.acceptedPayments': 'Aceptamos pagos',
    'footer.companyDescription1': 'XLab es una empresa líder en el campo del desarrollo de soluciones tecnológicas y software profesional para empresas.',
    'footer.companyDescription2': 'Con un equipo de expertos experimentados, XLab se enorgullece de ser un socio tecnológico de confianza para más de 500 empresas.',
    'footer.customers': '500+ Clientes',
    'footer.years': '5+ Años',
    'footer.support': '24/7 Soporte',
    ...
    'products.showing': 'Mostrando {count} resultados',
    'products.sortBy': 'Ordenar por',
    'products.sortNewest': 'Más recientes',
    'products.sortPriceLow': 'Precio de menor a mayor',
    'products.sortPriceHigh': 'Precio de mayor a menor',
    'products.sortPopular': 'Más populares',
    'products.sortRating': 'Mejor valorados',
    'products.loading': 'Cargando productos...',
    'products.errorTitle': 'No se pueden cargar los productos',
    'products.loadError': 'No se pueden cargar los productos',
    'products.invalidData': 'Formato de datos no válido',
    'products.error': 'Ha ocurrido un error',
    'products.tryAgain': 'Intentar de nuevo',
    'products.backToHome': 'Volver a inicio',
    'products.accounts': 'Cuentas de aprendizaje',
    
    // Product detail page
    'product.details': 'Detalles del producto',
    'product.specifications': 'Especificaciones',
    'product.requirements': 'Requisitos del sistema',
    'product.metaTitle': 'XLab - Software y Servicios',
    'product.loading': 'Cargando información del producto...',
    'product.version': 'Versión',
    'product.quantity': 'Cantidad',
    'product.availableIn': 'Disponible en',
    'product.price': 'Precio',
    'product.originalPrice': 'Precio original',
    'product.discount': 'Descuento',
    'product.relatedProducts': 'Productos relacionados',
    'product.relatedProductsSubtitle': 'Puede que te interesen productos similares',
    'product.reviews': 'Reseñas',
    'product.features': 'Características',
    'product.description': 'Descripción',
    'product.options': 'Opciones',
    'product.selectOption': 'Seleccionar opción',
    'product.downloadCount': 'Descargas',
    'product.viewCount': 'Vistas',
    'product.addedToCart': 'Se ha añadido {quantity} producto(s) al carrito',
    'product.outOfStock': 'Agotado',
    'product.inStock': 'En existencias',
    'product.tryDemo': 'Probar demo',
    'product.free': 'Gratis',
    ...
    'warranty.period': 'XLab garantiza todas las cuentas y software por <strong>{days} días</strong> a partir de la fecha de compra.',
    'warranty.processTitle': 'Proceso de garantía',
    'warranty.process': 'Cuando su cuenta tiene problemas, envíe una solicitud de soporte a través del formulario lateral o contáctenos directamente por Zalo, Email.',
    'warranty.conditionsTitle': 'Condiciones de garantía',
    'warranty.conditions': 'La cuenta debe estar dentro del período de garantía y ser utilizada según las normativas.',
    'warranty.refundPolicyTitle': 'Política de reembolso',
    'warranty.refundPeriodTitle': 'Período de reembolso',
    'warranty.refundPeriod': 'Dentro de los <strong>{days} días</strong> desde la fecha de compra, puede solicitar un reembolso si el producto no satisface sus necesidades.',
    ...
    'orders.noOrdersDesc': '¡Explora nuestros productos y haz un pedido ahora!',
    ...
    'testimonials.positions.CTO': 'Director de Tecnología',
    'testimonials.positions.CTO - Tech Solutions': 'Director de Tecnología',
    'testimonials.positions.Marketing Manager': 'Gerente de Marketing',
    'testimonials.positions.Developer': 'Desarrollador',
    'testimonial.position.project': 'Gerente de Proyectos',
    'testimonial.position.business': 'Director de Negocios',
