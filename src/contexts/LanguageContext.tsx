...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    'home.aboutDesc1': 'XLab es una plataforma que proporciona soluciones de software con IA avanzada para ayudar a los usuarios a mejorar su rendimiento en el trabajo y la vida cotidiana.',
    'home.aboutDesc2': 'Nuestra misión es ofrecer a las personas la oportunidad de acceder a herramientas para el trabajo, estudio y entretenimiento a precios asequibles y con calidad internacional.',
    ...
    'home.budgetOptions': 'Múltiples opciones para todo presupuesto',
    ...
    'home.noSoftware': 'Aún no hay software',
    'home.updateSoon': 'Actualizaremos el software próximamente.',
    'home.noServices': 'Aún no hay servicios',
    'home.updateServices': 'Actualizaremos los servicios próximamente.',
    'home.faq': 'Preguntas frecuentes',
    'home.faqDesc': 'Respuestas a las preguntas más comunes sobre productos y servicios de XLab',
    ...
    'home.faq2Desc': 'Después de comprar un producto, recibirá un código de activación por correo electrónico. Abra la aplicación, vaya a "Activar licencia" e ingrese este código para usar todas las funciones.',
    ...
    'home.faq4Desc': 'Tenemos una política de reembolso dentro de los 7 días posteriores a la compra si el producto no satisface sus necesidades. Póngase en contacto con el equipo de soporte para recibir orientación.',
    'home.faq5Title': '¿Cómo contacto al soporte técnico?',
    'home.faq5Desc': 'Puede contactar a nuestro equipo de soporte técnico por correo electrónico a support@xlab.vn, línea directa 1900.xxxx o chat en vivo en el sitio web. Respondemos dentro de 24 horas laborables.',
    'home.faq6Title': '¿XLab ofrece soluciones para empresas?',
    'home.faq6Desc': 'Sí, tenemos paquetes especiales para empresas con descuentos y soporte técnico especializado. Póngase en contacto con nosotros para obtener la solución más adecuada.',
    'home.moreQuestions': 'Ver más preguntas',
    'home.ctaTitle': '¿Listo para aumentar su productividad con XLab?',
    'home.ctaDesc': 'Ofrecemos precios especiales para clientes que compran en grandes cantidades. Cuanto más compre, mayor será el descuento. Nos comprometemos a ofrecerle las mejores soluciones a precios razonables.',
    ...
    'cart.apply': 'Aplicar',
    'cart.enterCoupon': 'Ingresar código de descuento',

    // Account page
    'account.myAccount': 'Mi cuenta',
    'account.manageInfo': 'Gestiona tu información personal, licencias e historial de compras.',
    'account.totalProducts': 'Total de productos comprados',
    'account.allActive': 'Todos activos',
    'account.noProducts': 'Aún no hay productos',
    'account.totalPaid': 'Total pagado',
    'account.throughOrders': 'A través de {count} pedidos',
    'account.totalSaved': 'Total ahorrado',
    'account.comparedToOriginal': 'En comparación con el precio original',
    ...
    'admin.settings.saveSuccess': '¡Configuraciones guardadas con éxito!',
    'admin.settings.saveError': 'Ocurrió un error al guardar las configuraciones',
    'admin.settings.errors': 'Ocurrieron errores',
    'admin.settings.tabGeneral': 'General',
    'admin.settings.tabPayment': 'Pago',
    'admin.settings.tabEmail': 'Correo electrónico',
    ...
    'admin.settings.logoUrl': 'URL del logotipo',
    'admin.settings.faviconUrl': 'URL del favicon',
    'admin.settings.contactInfo': 'Información de contacto',
    'admin.settings.contactEmail': 'Correo electrónico de contacto',
    ...
    'admin.settings.emailSettings': 'Configuración de correo electrónico',
    'admin.settings.enableEmailNotification': 'Habilitar notificaciones por correo electrónico',
    ...
    'admin.settings.senderEmail': 'Correo electrónico del remitente',
    ...
    'admin.settings.disableCheckout': 'Deshabilitar pago',
