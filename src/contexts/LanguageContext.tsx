...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    'home.faq1Desc': 'Puede descargar software gratuito en la página del producto correspondiente después de iniciar sesión en su cuenta. Para productos pagos, debe completar el pago antes de la descarga.',
    ...
    'home.faq3Title': '¿En cuántos dispositivos puedo usar el software?',
    'home.faq3Desc': 'Cada licencia le permite usar el software en un máximo de 3 dispositivos diferentes. Si desea usarlo en más dispositivos, compre licencias adicionales o actualice al plan empresarial.',
    ...
    'home.faq6Desc': 'Sí, tenemos paquetes de servicios especiales para empresas con descuentos de precio y soporte técnico dedicado. Póngase en contacto con nosotros para obtener la solución más adecuada.',
    'home.moreQuestions': 'Ver más preguntas',
    'home.ctaTitle': '¿Listo para mejorar la productividad con XLab?',
    'home.ctaDesc': 'Ofrecemos varios niveles de precios con descuentos especiales para clientes que compran en grandes cantidades. Cuanto más compre, mayor será el descuento. Nos comprometemos a ofrecerle las mejores soluciones con los costos más razonables.',
    ...
    'about.innovationDesc': 'Innovación y creatividad continuas en tecnología para proporcionar el mejor valor',
    ...
    'about.integrityDesc': 'Manteniendo siempre la ética empresarial y la transparencia en todas las operaciones',

    // Admin Settings
    'admin.settings.title': 'Configuración del sistema',
    'admin.settings.loadError': 'No se pudieron cargar las configuraciones (Error {status})',
    'admin.settings.connectionError': 'No se puede conectar con el servidor',
    'admin.settings.saveSuccess': '¡Configuración guardada con éxito!',
    'admin.settings.saveError': 'Ocurrió un error al guardar la configuración',
    'admin.settings.errors': 'Se produjeron errores',
    'admin.settings.tabGeneral': 'General',
    'admin.settings.tabPayment': 'Pago',
    'admin.settings.tabEmail': 'Email',
    'admin.settings.tabAdvanced': 'Avanzado',
    'admin.settings.siteInfo': 'Información del sitio web',
    ...
    'admin.settings.paymentSettings': 'Configuración de pago',
    ...
    'admin.settings.bankAccountName': 'Nombre de la cuenta',
    'admin.settings.bankAccountNumber': 'Número de cuenta',
    'admin.settings.emailSettings': 'Configuración de email',
    'admin.settings.enableEmailNotification': 'Habilitar notificaciones por email',
    ...
    'admin.settings.maintenanceMode': 'Modo mantenimiento',
    'admin.settings.disableRegistration': 'Deshabilitar registro de nuevos usuarios',
    'admin.settings.disableCheckout': 'Deshabilitar proceso de pago',
    'admin.settings.saving': 'Guardando...',
    'admin.settings.saveButton': 'Guardar configuración',

    // Admin Coupons
    'admin.coupons.title': 'Gestión de cupones',
    'admin.coupons.activeCount': 'Activo',
    'admin.coupons.expiredCount': 'Expirado',
    'admin.coupons.listTitle': 'Lista de cupones',
    'admin.coupons.activeTab': 'Activos',
    'admin.coupons.expiredTab': 'Expirados',
    'admin.coupons.noCoUponsMessage': 'Crea tu primer cupón para comenzar a ofrecer promociones a los clientes',
    'admin.coupons.createFirstButton': 'Crear primer cupón',
    'admin.coupons.codeColumn': 'Código / Nombre',
    'admin.coupons.typeColumn': 'Tipo / Valor',
    'admin.coupons.timeColumn': 'Período',
    'admin.coupons.usageColumn': 'Uso',
    'admin.coupons.statusColumn': 'Estado',
    'admin.coupons.actionsColumn': 'Acciones',
    'admin.coupons.percentageType': 'Porcentaje',
    'admin.coupons.fixedType': 'Monto fijo',
    'admin.coupons.cashbackType': 'Crédito',
    'admin.coupons.createSuccess': '¡Cupón creado con éxito!',
    'admin.coupons.createError': 'Ocurrió un error al crear el cupón',
    'admin.coupons.updateSuccess': '¡Actualizado con éxito!',
    'admin.coupons.updateError': 'Ocurrió un error durante la actualización',
    'admin.coupons.fetchError': 'No se pudo cargar la lista de cupones',
    'admin.coupons.toggleError': 'Ocurrió un error al actualizar el estado',
    ...
    'admin.coupons.totalUsageLimit': 'Conteo máximo de uso (0 = ilimitado)',
    'admin.coupons.totalUsageDesc': 'El conteo de uso se aplica a todo el cupón.',
    'admin.coupons.perUserLimit': 'Usos por cliente (0 = ilimitado)',
    'admin.coupons.perUserLimitDesc': 'Limite cuántas veces cada usuario puede usar este cupón.',
    ...
    'admin.coupons.stop': 'Detener',
    'admin.coupons.clickToEdit': 'Clic para editar',
    'admin.coupons.clickToEditType': 'Clic para editar tipo de descuento',
    'admin.coupons.clickToEditUsage': 'Clic para editar conteo de uso',
    'admin.coupons.save': 'Guardar',
    'admin.coupons.cancel': 'Cancelar',
    'admin.coupons.confirmDelete': '¿Está seguro de que desea eliminar este cupón?',
    'admin.coupons.deleteSuccess': '¡El cupón ha sido eliminado con éxito!',
    'admin.coupons.deleteError': 'Ocurrió un error al eliminar el cupón',
    'admin.coupons.activateSuccess': '¡El cupón ha sido activado con éxito!',
    'admin.coupons.deactivateSuccess': '¡El cupón ha sido desactivado con éxito!',
    'admin.coupons.basicInfo': 'Información básica',
    'admin.coupons.code': 'Código de cupón',
    'admin.coupons.codePlaceholder': 'Ej: VERANO2024',
    'admin.coupons.generateAuto': 'Generar automáticamente',
    'admin.coupons.name': 'Nombre del cupón',
    'admin.coupons.namePlaceholder': 'Ej: Descuento de verano',
    'admin.coupons.typeAndValue': 'Tipo y valor',
    'admin.coupons.type': 'Tipo de descuento',
    'admin.coupons.value': 'Valor del descuento',
    'admin.coupons.minOrderDesc': 'Valor mínimo del pedido para aplicar este cupón.',
    'admin.coupons.expired': 'Expirado',
    'admin.coupons.active': 'Activo', 
    'admin.coupons.inactive': 'Inactivo',
    'admin.coupons.activate': 'Activar',
    'admin.coupons.processing': 'Procesando...',
    'admin.coupons.editTitle': 'Editar cupón:',
    'admin.coupons.updating': 'Actualizando...',
    'admin.coupons.updateButton': 'Actualizar',
    'admin.coupons.usageCount': 'usos',
    
    // Warranty page
    'warranty.title': 'Garantía',
    'warranty.subtitle': '¡XLab está listo para brindar consultoría y servicio de garantía durante 365 días!',
    'warranty.policyTitle': 'Política de garantía',
    'warranty.periodTitle': 'Periodo de garantía',
    'warranty.period': 'XLab garantiza todos los productos y software por <strong>{days} días</strong> desde la fecha de compra.',
    'warranty.processTitle': 'Proceso de garantía',
    'warranty.process': 'Cuando su cuenta presente problemas, envíe una solicitud de soporte a través del formulario o contáctenos directamente a través de Zalo, Email.',
    'warranty.conditionsTitle': 'Condiciones de garantía',
    'warranty.conditions': 'La cuenta debe estar dentro del período de garantía y utilizarse según las regulaciones.',
