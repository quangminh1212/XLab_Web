...
export const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'contact.pageSubtitle': 'Contáctenos para recibir asesoramiento sobre la solución más adecuada para su empresa.',
    'contact.sendMessage': 'Envíenos un mensaje',
    'contact.yourName': 'Su nombre',
    'contact.yourEmail': 'Su correo electrónico',
    'contact.yourPhone': 'Su teléfono',
    'contact.yourCompany': 'Su empresa',
    'contact.serviceInterest': 'Servicio que le interesa',
    'contact.message': 'Mensaje',
    'contact.send': 'Enviar mensaje',
    'contact.sending': 'Enviando...',
    'contact.successMessage': '¡Gracias por contactarnos! Le responderemos pronto.',
    'contact.errorMessage': 'Hubo un error al enviar el mensaje. Por favor, inténtelo de nuevo.',
    'contact.info': 'Información de contacto',
    'contact.connectWithUs': 'Conéctese con nosotros',
    'contact.address': 'Long Bien, Ha Noi',
    'contact.email': 'xlab.rnd@gmail.com',
    'contact.phone': '+84 866 528 014',
