...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'testimonials.recent': 'Opiniones recientes',
    'testimonials.writeReview': 'Escribir una reseña',
    'testimonials.satisfied': '¿Satisfecho con el producto?',
    'testimonials.viewAll': 'Ver todas las opiniones',
    'testimonials.ratings': 'reseñas',
    'testimonials.pageTitle': 'Opiniones de clientes',
    'testimonials.pageSubtitle': 'Descubra las experiencias y resultados reales que nuestros clientes han logrado utilizando las soluciones XLab',
    'testimonials.clientsTab': 'Opiniones de clientes',
    'testimonials.caseStudiesTab': 'Casos de éxito',
    'testimonial.michael': '"He estado usando los servicios de XLab durante 2 años y estoy extremadamente satisfecho. El software funciona sin problemas, tiene características completas y el equipo de soporte es muy dedicado."',
    'testimonial.david': '"Las soluciones de IA de XLab han ayudado a nuestro negocio a ahorrar un 30% en costos operativos. El equipo de soporte técnico responde rápida y eficazmente."',
    'testimonial.emily': '"Las actualizaciones continuas de XLab garantizan que el producto siempre cumpla con nuestras demandas cada vez más altas. La interfaz es amigable y fácil de usar incluso para los principiantes."',
  ...
  vi: {
    ...
    'testimonials.verified': 'Đã xác minh',
    'testimonials.recent': 'Đánh giá gần đây',
    'testimonials.writeReview': 'Viết đánh giá',
    'testimonials.satisfied': 'Hài lòng với sản phẩm?',
    ...
    'notifications.demo.title': 'Demo notification',
