...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'about.storyP1': 'XLab fue fundada en 2018 por un grupo de ingenieros de software apasionados con visión de crear soluciones tecnológicas avanzadas para ayudar a las empresas vietnamitas a mejorar la eficiencia operativa y la competitividad en la era digital.',
    ...
    'about.storyP3': 'Estamos orgullosos de nuestro talentoso equipo apasionado por la tecnología, con más de 100 expertos en software, ingenieros de sistemas y consultores experimentados, siempre dedicados a brindar soluciones óptimas a nuestros socios y clientes.',
    'about.mission': 'Misión',
    'about.missionDesc': 'La misión de XLab es aplicar tecnología avanzada para crear excelentes soluciones de software que ayuden a las empresas vietnamitas a optimizar procesos, aumentar la productividad y desarrollarse de manera sostenible en la era digital. Nos comprometemos a ofrecer productos y servicios de alta calidad que satisfagan las diversas necesidades de los clientes, contribuyendo al desarrollo de la industria de TI en Vietnam.',
    'about.vision': 'Visión',
    'about.visionDesc': 'XLab aspira a convertirse en una empresa tecnológica líder en Vietnam y el Sudeste Asiático en el campo del desarrollo de software y soluciones integrales de TI. Nos esforzamos por ser un socio confiable y duradero para las empresas en su viaje de transformación digital, y también un entorno de trabajo ideal para que los talentos tecnológicos desarrollen sus carreras.',
    'about.coreValues': 'Valores fundamentales',
    'about.coreValuesDesc': 'Los valores que definen nuestra cultura y guían todas nuestras actividades',
    'about.value1': 'Calidad',
    'about.value1Desc': 'Priorizamos la calidad de productos y servicios, mejorando continuamente para lograr la excelencia',
    'about.value2': 'Innovación',
    'about.value2Desc': 'Fomentamos el pensamiento creativo, atreviéndonos a experimentar con nuevas ideas y tecnologías avanzadas',
    'about.value3': 'Colaboración',
    'about.value3Desc': 'Construimos relaciones duraderas basadas en el respeto y la cooperación mutuamente beneficiosa',
    'about.value4': 'Responsabilidad',
    'about.value4Desc': 'Trabajamos con alto sentido de responsabilidad, comprometidos a cumplir todos los compromisos con los clientes',
    
    // Contact page
    'contact.title': 'Contáctenos',
    'contact.subtitle': 'Póngase en contacto con nosotros para obtener asesoramiento sobre la solución más adecuada para su empresa.',
    'contact.pageTitle': 'Contáctenos',
    'contact.pageSubtitle': 'Póngase en contacto con nosotros para obtener asesoramiento sobre la solución más adecuada para su empresa.',
    'contact.sendMessage': 'Envíenos un mensaje',
    'contact.yourName': 'Su nombre completo',
    'contact.yourEmail': 'Su correo electrónico',
    'contact.yourPhone': 'Número de teléfono',
    'contact.yourCompany': 'Empresa',
    'contact.serviceInterest': 'Servicio que le interesa',
