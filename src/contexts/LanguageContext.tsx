...
export const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    'orders.history_vi': 'Lịch sử đơn hàng của bạn',
    'orders.orderCode_vi': 'Mã đơn hàng',
    'orders.orderDate_vi': 'Ngày đặt',
    'orders.quantity_vi': 'Số lượng',
    'orders.status_vi': 'Trạng thái',
    'orders.total_vi': 'Tổng cộng',
    'orders.viewDetails_vi': 'Xem chi tiết',
    'orders.completed_vi': 'Hoàn thành',
    'orders.pending_vi': 'Chờ xử lý',
    'orders.processing_vi': 'Đang xử lý',
    'orders.cancelled_vi': 'Đã hủy',
    'orders.refunded_vi': 'Hoàn tiền',
    'orders.noOrders_vi': 'Bạn chưa có đơn hàng nào',
    'orders.exploreProducts_vi': 'Xem sản phẩm',
    'orders.noOrdersDesc_vi': 'Hãy khám phá các sản phẩm của chúng tôi và đặt hàng ngay!',
    'orders.needLogin_vi': 'Bạn cần đăng nhập',
    'orders.needLoginDesc_vi': 'Vui lòng đăng nhập để xem lịch sử đơn hàng của bạn',
    'orders.login_vi': 'Đăng nhập',
    'notifications.none_vi': 'Không có thông báo nào',
    'product.details_vi': 'Chi tiết sản phẩm',
    'product.features_vi': 'Tính năng',
    'product.frequentlyAskedQuestions_vi': 'Câu hỏi thường gặp',
    'product.relatedProducts_vi': 'Sản phẩm liên quan',
    'product.mightAlsoLike_vi': 'Bạn có thể thích',
    'product.options_vi': 'Tùy chọn',
    ...
    // User Notifications
    'notifications.title_vi': 'Your Notifications',
    'notifications.markAllRead_vi': 'Mark all as read',
    'notifications.all_vi': 'All',
    'notifications.unread_vi': 'Unread',
    'notifications.viewDetails_vi': 'View details',
    'notifications.viewNow_vi': 'View now',
    'notifications.empty_vi': 'No notifications',
    'notifications.allRead_vi': 'You have read all notifications!',
    'notifications.noNotifications_vi': 'You don\'t have any notifications yet. Please check back later.',
    'notifications.loading_vi': 'Loading...',
    'notifications.backToHome_vi': 'Back to home',
    'notifications.justNow_vi': 'Just now',
    'notifications.demo.title_vi': 'Notification Demo',
    'notifications.demo.description_vi': 'Use this tool to create new notifications to test the notification system.',
    'notifications.demo.type_vi': 'Notification type',
    'notifications.demo.create_vi': 'Create notification',
    'notifications.demo.note_vi': 'Note',
    'notifications.demo.noteText_vi': 'Demo notifications will be added to your notification list and will be displayed in the Header. In a real environment, notifications will be created by the system or from user activities.',
    'notifications.type.promotion_vi': 'Promotion',
    'notifications.type.update_vi': 'Update',
    'notifications.type.order_vi': 'Order',
    'notifications.type.system_vi': 'System',
    'notifications.demo.promotionTitle_vi': 'New promotion',
    'notifications.demo.promotionContent_vi': 'Special promotion just for you! 30% off all products.',
    'notifications.demo.updateTitle_vi': 'New update',
    'notifications.demo.updateContent_vi': 'Version 2.0 has been released with many new features',
    'notifications.demo.orderTitle_vi': 'New order',
    'notifications.demo.orderContent_vi': 'Your order has been processed and is being shipped.',
    'notifications.demo.systemTitle_vi': 'System notification',
    'notifications.demo.systemContent_vi': 'The system will undergo maintenance at 10:00 PM tonight. We apologize for any inconvenience.',
    ...
    'orders.noOrders_vi2': 'Bạn chưa có đơn hàng nào',
    'orders.exploreProducts_vi2': 'Xem sản phẩm',
    'orders.noOrdersDesc_vi2': 'Hãy khám phá các sản phẩm của chúng tôi và đặt hàng ngay!',
    'orders.needLogin_vi2': 'Bạn cần đăng nhập',
    'orders.needLoginDesc_vi2': 'Vui lòng đăng nhập để xem lịch sử đơn hàng của bạn',
    'orders.login_vi2': 'Đăng nhập',
    'notifications.none_vi2': 'Không có thông báo nào',
    'product.details_vi2': 'Product details',
    'product.features_vi2': 'Features',
    'product.frequentlyAskedQuestions_vi2': 'Frequently Asked Questions',
    'product.relatedProducts_vi2': 'Related products',
    'product.mightAlsoLike_vi2': 'You might also like',
    'product.options_vi2': 'Options',
  },
  en: {
    // Admin Notifications
