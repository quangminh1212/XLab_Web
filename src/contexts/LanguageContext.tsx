...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    'contact.subtitle': 'Estamos aquí para ayudarle y responder cualquier pregunta que pueda tener',
    'contact.pageTitle': 'Contáctenos',
    'contact.pageSubtitle': 'Póngase en contacto con nosotros para obtener asesoramiento sobre la mejor solución para su empresa',
    ...
    'contact.errorMessage': 'Se produjo un error al enviar el formulario. Inténtelo de nuevo más tarde.',
    ...
    'contact.faqSubtitle': 'Encuentre respuestas rápidas a preguntas comunes',
    'contact.followUs': 'Síganos en redes sociales',
    'contact.newsletterTitle': 'Suscríbase a Nuestro Boletín',
    'contact.newsletterSubtitle': 'Obtenga las últimas noticias y actualizaciones',
    'contact.newsletterPlaceholder': 'Introduzca su correo electrónico',
    ...
    'products.sortRating': 'Mejor valorado',
    ...
    'products.error': 'Se produjo un error',
    ...
    'product.relatedProductsSubtitle': 'Puede interesarte productos similares',
    ...
    'product.addedToCart': 'Añadido {quantity} producto(s) al carrito',
    ...
    'filter.noResults': 'No se encontraron resultados',
    ...
    'warranty.subtitle': '¡XLab está listo para brindar asesoramiento y servicio de garantía durante 365 días!',
    'warranty.policyTitle': 'Política de Garantía',
    'warranty.periodTitle': 'Período de Garantía',
    'warranty.period': 'XLab garantiza todos los productos y servicios por <strong>{days} días</strong> desde la fecha de compra.',
    'warranty.processTitle': 'Proceso de Garantía',
    'warranty.process': 'Cuando su cuenta tenga problemas, envíe una solicitud de soporte a través del formulario o contáctenos directamente por Zalo, correo electrónico.',
    'warranty.conditionsTitle': 'Condiciones de Garantía',
    'warranty.conditions': 'La cuenta debe estar dentro del período de garantía y utilizarse de acuerdo con las regulaciones.',
    ...
    'warranty.refundConditions': 'El producto no ha sido modificado, manipulado y no viola los términos de uso.',
    'warranty.refundProcessTitle': 'Proceso de Reembolso',
    'warranty.refundProcess': 'Después de confirmar la solicitud válida, reembolsaremos a través del método de pago original dentro de 3-5 días hábiles.',
    'warranty.supportRequestTitle': 'Solicitud de Soporte Técnico',
    'warranty.submitSuccess': '¡Gracias por enviar su solicitud! Responderemos lo antes posible.',
    'warranty.formError': 'Ocurrió un error al enviar la solicitud. Por favor, inténtelo de nuevo más tarde.',
    'warranty.formName': 'Nombre Completo',
    'warranty.formEmail': 'Correo Electrónico',
    'warranty.formPhone': 'Número de Teléfono',
    'warranty.formOrderCode': 'Código de Pedido',
    'warranty.formAccountName': 'Nombre de la Cuenta',
    'warranty.formProblem': 'Descripción del Problema',
    'warranty.formProblemPlaceholder': 'Describa detalladamente el problema que está experimentando',
    'warranty.formSubmitting': 'Enviando...',
    'warranty.formSubmit': 'Enviar Solicitud de Soporte',
    'warranty.contactInfoTitle': 'Información de Contacto',
    'warranty.supportInfo1': 'XLab brinda asesoría de compra o garantía desde las <strong>8:00 AM hasta las 9:00 PM todos los días (incluidos festivos)</strong>. Procesamos muchos pedidos todos los días y atenderemos cada solicitud por orden.',
    'warranty.supportInfo2': 'Para un soporte de garantía rápido, complete el problema específico en el formulario de solicitud. Verificaremos, guiaremos sobre cómo solucionar el error o enviaremos una nueva cuenta automáticamente.',
    'warranty.address': 'Dirección',
    'warranty.workingHours': 'Horario Laboral',
    'warranty.ourMission': 'Nuestra Misión',
    'warranty.missionDescription': 'La misión de XLab es proporcionar a las personas acceso a herramientas para trabajo, estudio y entretenimiento a precios razonables y con calidad internacional.',
    'warranty.contactNow': 'Contactar Ahora',
