...
export const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    'footer.acceptedPayments': 'Phương thức thanh toán',
    'footer.companyDescription1': 'XLab là công ty hàng đầu trong lĩnh vực giải pháp công nghệ và phát triển phần mềm chuyên nghiệp cho doanh nghiệp.',
