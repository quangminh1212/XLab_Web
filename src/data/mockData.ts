...
export const categories: Category[] = [
  {
    ...
    imageUrl: '/images/categories/enterprise.svg',
    productCount: 4
  },
  {
    id: 'cat-2',
  ...
  },
  {
    ...
    imageUrl: '/images/categories/design.svg',
    productCount: 2
  },
  {
    id: 'cat-4',
    ...
    imageUrl: '/images/categories/security.svg',
    productCount: 2
  },
  {
    id: 'cat-5',
...
- Bảo mật cao, an toàn dữ liệu`,
    ...
    salePrice: 990000,
    categoryId: 'cat-2',
    imageUrl: '/images/products/office-suite.png',
    featured: true,
    isNew: false,
    downloadCount: 15240,
    viewCount: 45720,
...
- Dễ dàng mở rộng theo quy mô doanh nghiệp`,
    ...
    salePrice: 25000000,
    categoryId: 'cat-1',
    imageUrl: '/images/products/erp-system.png',
    featured: true,
    isNew: true,
    downloadCount: 5240,
    viewCount: 18450,
...
- Cập nhật liên tục cơ sở dữ liệu virus`,
    ...
    salePrice: 590000,
    categoryId: 'cat-4',
    imageUrl: '/images/products/antivirus.png',
    featured: false,
    isNew: false,
    downloadCount: 25600,
    viewCount: 68420,
...
- Cập nhật thường xuyên với tính năng mới`,
    ...
    salePrice: 2790000,
    categoryId: 'cat-3',
    imageUrl: '/images/products/design-studio.png',
    featured: true,
    isNew: false,
    downloadCount: 12480,
    viewCount: 37950,
...
- Dễ dàng mở rộng theo quy mô doanh nghiệp`,
    ...
    salePrice: 12000000,
    categoryId: 'cat-1',
    imageUrl: '/images/products/crm.png',
    featured: false,
    isNew: true,
    downloadCount: 8750,
    viewCount: 24680,
...
- Cập nhật thường xuyên`,
    ...
    salePrice: 1490000,
    categoryId: 'cat-4',
    imageUrl: '/images/products/data-recovery.png',
    featured: false,
    isNew: false,
    downloadCount: 18200,
    viewCount: 42560,
...
- Tài nguyên học tập phong phú`,
    ...
    salePrice: 2490000,
    categoryId: 'cat-3',
    imageUrl: '/images/products/video-editor.png',
    featured: true,
    isNew: false,
    downloadCount: 14560,
    viewCount: 37820,
...
- Cập nhật thường xuyên theo quy định mới`,
    ...
    salePrice: 4800000,
    categoryId: 'cat-1',
    imageUrl: '/images/products/accounting.png',
    featured: false,
    isNew: true,
    downloadCount: 9800,
    viewCount: 26450,
...
- Tiết kiệm chi phí so với Adobe Acrobat`,
    ...
    salePrice: 990000,
    categoryId: 'cat-2',
    imageUrl: '/images/products/pdf-master.png',
    featured: false,
    isNew: false,
    downloadCount: 22400,
    viewCount: 58760,
...
- Trải nghiệm học tập đa phương tiện`,
    ...
    salePrice: 15000000,
    categoryId: 'cat-5',
    imageUrl: '/images/products/lms.png',
    featured: false,
    isNew: true,
    downloadCount: 6200,
    viewCount: 18640,
...
- Hỗ trợ PGP mã hóa`,
    ...
    salePrice: 690000,
    categoryId: 'cat-2',
    imageUrl: '/images/products/mail-client.png',
    featured: false,
    isNew: false,
    downloadCount: 19800,
    viewCount: 42560,
...
- Tương thích với các thiết bị di động`,
    ...
    salePrice: 7200000,
    categoryId: 'cat-1',
    imageUrl: '/images/products/inventory.png',
    featured: false,
    isNew: false,
    downloadCount: 7840,
    viewCount: 22360,
