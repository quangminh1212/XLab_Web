...
const common = {
  ...
  'footer.cta.title': 'Ready to partner with XLab?',
  'footer.cta.desc': 'Get a free consultation for your project or explore the right pricing plan.',
  'footer.cta.contact': 'Contact us',
  'footer.cta.pricing': 'See pricing',
  ...
  'cart.emptyCartMessage': 'Your cart is currently empty.',
  'cart.continueShopping': 'Continue Shopping',
  'cart.productInCart': 'Products in Cart',
