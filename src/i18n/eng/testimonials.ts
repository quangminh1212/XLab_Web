// English language data for testimonials
export const testimonials = {
  cta: {
    title: 'Ready to get started?',
    description: 'Contact us today to discuss your project or explore our services.',
    contact: 'Contact Us',
  ...
  'clientsTab': 'Client Testimonials',
  'caseStudiesTab': 'Case Studies',
  'videoTitle': 'Video Testimonials',
  'videoSubtitle': 'Watch videos from customers sharing their experience using XLab products and services',
