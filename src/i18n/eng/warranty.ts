const warranty = {
  ...
  conditions: "Our warranty covers defects in materials and workmanship under normal use. Warranty applies when product policies are not violated. Damage from misuse, accidents, or unauthorized modifications is not covered under warranty.",
  ...
  refundConditions: "Products must be returned in their original condition with all packaging and accessories. Refunds apply when product policies are not violated. Digital products and customized solutions have specific refund conditions.",
