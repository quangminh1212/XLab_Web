export default {
  ...
  'category.business-solutions': 'Giải pháp doanh nghiệp',
  'category.security-software': 'Phần mềm bảo mật',
  'category.data-protection': 'Bảo vệ dữ liệu',
  'category.design-software': 'Phần mềm thiết kế',
  
  // Discount formats
  'discount.percentage': 'Giảm {value}%',
  'discount.percentageWithMax': 'Giảm {value}% (tối đa {max})',
  'discount.fixed': 'Giảm {value}',
  
  // Confirmations
  'confirm.deleteProduct': 'Bạn có chắc chắn muốn xóa sản phẩm này?',
  
  // Success messages
  'success.productDeleted': 'Đã xóa sản phẩm thành công!',
  
  // Error messages
  'error.deleteProduct': 'Không thể xóa sản phẩm',
  'error.deletingProduct': 'Lỗi khi xóa sản phẩm:',
