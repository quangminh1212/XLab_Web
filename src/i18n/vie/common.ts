...
const common = {
  ...
  'footer.cta.title': 'Sẵn sàng đồng hành cùng XLab?',
  'footer.cta.desc': 'Nhận tư vấn miễn phí cho dự án của bạn hoặc khám phá bảng giá phù hợp.',
  'footer.cta.contact': 'Liên hệ ngay',
  'footer.cta.pricing': 'Xem bảng giá',
  'footer.trustedBy': 'Được tin dùng bởi',
  ...
  'cart.emptyCartMessage': 'Giỏ hàng của bạn hiện đang trống.',
  'cart.continueShopping': 'Tiếp tục mua sắm',
  'cart.productInCart': 'Sản phẩm trong giỏ',
  ...
  'cart.price': 'Giá',
  'cart.actions': 'Thao tác',
  'cart.couponInvalid': 'Mã giảm giá không hợp lệ',
  'cart.couponApplied': 'Đã áp dụng mã giảm giá',
  'cart.couponRemoved': 'Đã xóa mã giảm giá',
  'cart.recommendedProducts': 'Sản phẩm được đề xuất',
