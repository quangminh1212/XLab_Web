        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
              ...
              <div className="flex space-x-4">
                ...
                <button 
                  ...
                  onClick={(e) => {
                    ...
                    // Hiển thị form thông qua state
                    setShowForm(true);
                    
                    // Alert để debug
                    alert("Đang mở form thêm sản phẩm mới");
                  }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {showForm && (
              <div 
                id="form-container" 
                className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-70 flex items-center justify-center z-[9999] p-4"
                style={{ position: 'fixed', inset: 0 }}
              >
                <div className="bg-white rounded-lg shadow-2xl overflow-auto max-h-[90vh] w-full max-w-5xl border-4 border-primary-500">
