    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold mb-4">
          {language === 'vie' ? 'Thống kê tổng quan' : 'Overview Statistics'}
        </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <h3 className="text-gray-500 text-sm font-medium">
                {language === 'vie' ? 'Sản phẩm' : 'Products'}
              </h3>
              ...
              >
                {language === 'vie' ? 'Quản lý →' : 'Manage →'}
              </Link>
            </div>

            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <h3 className="text-gray-500 text-sm font-medium">
                {language === 'vie' ? 'Người dùng' : 'Users'}
              </h3>
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              ...
              <p className="mt-2 text-3xl font-bold">{formatCurrency(stats.revenue, language)}</p>
              <Link
                href="/admin/orders"
                className="text-teal-600 hover:text-teal-800 text-sm mt-1 inline-block"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-bold mb-4">
            {language === 'vie' ? 'Sản phẩm mới nhất' : 'Latest Products'}
          </h2>
          {isLoading ? (
            <div className="flex justify-center items-center h-32">
            ...
            <p className="text-gray-500 text-center py-4">
              {language === 'vie' ? 'Chưa có sản phẩm nào' : 'No products yet'}
            </p>
          )}
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-bold mb-4">
            {language === 'vie' ? 'Tác vụ nhanh' : 'Quick Actions'}
          </h2>
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="font-medium">
                    {language === 'vie' ? 'Thêm thông báo' : 'Add Notification'}
                  </h3>
                  <p className="text-sm">
                    {language === 'vie' 
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="font-medium">
                    {language === 'vie' ? 'Thêm mã giảm giá' : 'Add Coupon'}
                  </h3>
                  <p className="text-sm">
                    {language === 'vie' 
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="font-medium">
                    {language === 'vie' ? 'Quản lý đơn hàng' : 'Manage Orders'}
                  </h3>
                  <p className="text-sm">
                    {language === 'vie' 
            ...
            >
              {language === 'vie' ? 'Về trang chính' : 'Back to main page'}
            </Link>
          </div>
        </div>
      </div>
