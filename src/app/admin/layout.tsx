                        ...
                        <nav className="p-2">
                            <ul className="space-y-2">
                                <li>
                                    <Link
                                        href="/admin"
                                        className={`flex items-center px-4 py-3 rounded text-gray-800 hover:bg-primary-50 transition-colors ${isActive('/admin')} ${isSidebarCollapsed ? 'justify-center' : ''}`}
                                        title="Dashboard"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${isSidebarCollapsed ? '' : 'mr-3'} ${pathname === '/admin' ? 'text-white' : 'text-primary-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${isSidebarCollapsed ? '' : 'mr-3'} ${pathname === '/admin/products' ? 'text-white' : 'text-primary-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${isSidebarCollapsed ? '' : 'mr-3'} ${pathname === '/admin/users' ? 'text-white' : 'text-primary-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${isSidebarCollapsed ? '' : 'mr-3'} ${pathname === '/admin/orders' ? 'text-white' : 'text-primary-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${isSidebarCollapsed ? '' : 'mr-3'} ${pathname === '/admin/settings' ? 'text-white' : 'text-primary-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
