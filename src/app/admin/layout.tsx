...
export default function AdminLayout({
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            {/* Header */}
            <header className="bg-gradient-to-r from-primary-600 via-primary-700 to-primary-800 text-white">
                <div className="container mx-auto py-6 px-4">
                    <div className="flex justify-between items-center">
                        ...
                        <div>
                            <Link
                                href="/"
                                className="px-4 py-2 bg-white text-primary-600 rounded hover:bg-gray-100 transition-colors duration-200"
                            >
                                Về trang chính
                            </Link>
                        </div>
            ...
            <div className="container mx-auto py-6 px-4 flex flex-col md:flex-row gap-6">
                ...
                <div className={`transition-all duration-300 ease-in-out ${isSidebarCollapsed ? 'w-16 md:w-16' : 'w-full md:w-64'} shrink-0`}>
                    <div className="bg-white rounded-lg shadow overflow-hidden sticky top-6">
                        <div className={`p-4 bg-primary-600 text-white font-medium flex ${isSidebarCollapsed ? 'justify-center' : 'justify-between'} items-center`}>
                            {!isSidebarCollapsed && <span>Menu quản trị</span>}
                            <button 
                                onClick={toggleSidebar} 
                                className="text-white focus:outline-none hover:bg-primary-700 rounded p-2 transition-colors"
                        ...
                        <nav className="p-2">
                            <ul className="space-y-2">
                                <li>
                                    <Link
                                        href="/admin"
                                        className={`flex items-center px-4 py-3 rounded text-gray-800 hover:bg-primary-50 transition-colors ${isActive('/admin') || 'text-primary-600'} ${isSidebarCollapsed ? 'justify-center' : ''}`}
                                        title="Dashboard"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${pathname === '/admin' ? 'text-white' : 'text-primary-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    <Link
                                        href="/admin/products"
                                        className={`flex items-center px-4 py-3 rounded text-gray-800 hover:bg-primary-50 transition-colors ${isActive('/admin/products') || 'text-primary-600'} ${isSidebarCollapsed ? 'justify-center' : ''}`}
                                ...
                                <li>
                                    <Link
                                        href="/admin/users"
                                        className={`flex items-center px-4 py-3 rounded text-gray-800 hover:bg-primary-50 transition-colors ${isActive('/admin/users') || 'text-primary-600'} ${isSidebarCollapsed ? 'justify-center' : ''}`}
                                ...
                                <li>
                                    <Link
                                        href="/admin/orders"
                                        className={`flex items-center px-4 py-3 rounded text-gray-800 hover:bg-primary-50 transition-colors ${isActive('/admin/orders') || 'text-primary-600'} ${isSidebarCollapsed ? 'justify-center' : ''}`}
                                ...
                                <li>
                                    <Link
                                        ...
                                        className={`flex items-center px-4 py-3 rounded text-gray-800 hover:bg-primary-50 transition-colors ${isActive('/admin/notifications') || 'text-primary-600'} ${isSidebarCollapsed ? 'justify-center' : ''}`}
                                ...
                                <li>
                                    <Link
                                        href="/admin/coupons"
                                        className={`flex items-center px-4 py-3 rounded text-gray-800 hover:bg-primary-50 transition-colors ${isActive('/admin/coupons') || 'text-primary-600'} ${isSidebarCollapsed ? 'justify-center' : ''}`}
                                    ...
                                    >
                                        ...
                                        {!isSidebarCollapsed && (
                                            <span className="ml-3">Quản lý mã giảm giá</span>
                                        )}
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                        href="/admin/settings"
                                        className={`flex items-center px-4 py-3 rounded text-gray-800 hover:bg-primary-50 transition-colors ${isActive('/admin/settings') || 'text-primary-600'} ${isSidebarCollapsed ? 'justify-center' : ''}`}
