            ...
            <div className="container mx-auto py-6 px-4 flex flex-col md:flex-row gap-6">
                ...
                <div className={`transition-all duration-300 ease-in-out ${isSidebarCollapsed ? 'w-16 md:w-16' : 'w-full md:w-64'} shrink-0`}>
                    <div className="bg-white rounded-lg shadow overflow-hidden sticky top-6">
                        <div className={`p-4 bg-teal-600 text-white font-medium flex ${isSidebarCollapsed ? 'justify-center' : 'justify-between'} items-center`}>
                            ...
                            <ul className="space-y-2">
                                <li>
                                    <Link
                                        ...
                                        title="Dashboard"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${pathname === '/admin' ? 'text-white' : 'text-teal-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${(pathname === '/admin/products' || pathname.startsWith('/admin/products/')) ? 'text-white' : 'text-teal-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${(pathname === '/admin/users' || pathname.startsWith('/admin/users/')) ? 'text-white' : 'text-teal-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${(pathname === '/admin/orders' || pathname.startsWith('/admin/orders/')) ? 'text-white' : 'text-teal-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${(pathname === '/admin/notifications' || pathname.startsWith('/admin/notifications/')) ? 'text-white' : 'text-teal-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${(pathname === '/admin/coupons' || pathname.startsWith('/admin/coupons/')) ? 'text-white' : 'text-teal-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${(pathname === '/admin/settings' || pathname.startsWith('/admin/settings/')) ? 'text-white' : 'text-teal-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
