...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const isActive = (path: string) => {
    ...
    // For main admin page, only active when exact match
    if (path === '/admin') {
    ...
    // For sub-pages, only active when pathname starts with path
  ...
  useEffect(() => {
    ...
    // Use isAdmin instead of directly checking email
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-gradient-to-r from-teal-600 via-teal-700 to-teal-800 text-white">
        <div className="mx-auto py-6 px-0 sm:px-4 max-w-full md:max-w-[98%] xl:max-w-[1280px] 2xl:max-w-[1400px]">
          <div className="flex justify-between items-center">
            ...
            <div>
              ...
              >
                {localCode === 'vi' ? 'Về trang chính' : 'Back to main page'}
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* Main content */}
      <div className="mx-auto py-6 px-0 sm:px-4 flex flex-col md:flex-row gap-6 max-w-full md:max-w-[98%] xl:max-w-[1280px] 2xl:max-w-[1400px]">
        {/* Sidebar */}
        <div
        ...
        >
          <div className="bg-white rounded-lg shadow overflow-hidden sticky top-6">
            ...
            >
              {!isSidebarCollapsed && <span>{localCode === 'vi' ? 'Menu quản trị' : 'Admin Menu'}</span>}
              <button
                onClick={toggleSidebar}
                className="text-white focus:outline-none hover:bg-teal-700 rounded p-2 transition-colors"
                aria-label={isSidebarCollapsed 
                  ? (localCode === 'vi' ? 'Mở rộng menu' : 'Expand menu') 
                  : (localCode === 'vi' ? 'Thu gọn menu' : 'Collapse menu')}
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    ...
                    title={localCode === 'vi' ? "Bảng điều khiển" : "Dashboard"}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    {!isSidebarCollapsed && <span className="ml-3">{localCode === 'vi' ? 'Bảng điều khiển' : 'Dashboard'}</span>}
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    title={localCode === 'vi' ? "Quản lý sản phẩm" : "Product Management"}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    {!isSidebarCollapsed && <span className="ml-3">{localCode === 'vi' ? 'Quản lý sản phẩm' : 'Products'}</span>}
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    title={localCode === 'vi' ? "Quản lý người dùng" : "User Management"}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    {!isSidebarCollapsed && <span className="ml-3">{localCode === 'vi' ? 'Quản lý người dùng' : 'Users'}</span>}
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    title={localCode === 'vi' ? "Quản lý đơn hàng" : "Order Management"}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    {!isSidebarCollapsed && <span className="ml-3">{localCode === 'vi' ? 'Quản lý đơn hàng' : 'Orders'}</span>}
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    title={localCode === 'vi' ? "Quản lý thông báo" : "Notification Management"}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    {!isSidebarCollapsed && <span className="ml-3">{localCode === 'vi' ? 'Quản lý thông báo' : 'Notifications'}</span>}
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    title={localCode === 'vi' ? "Quản lý mã giảm giá" : "Coupon Management"}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    {!isSidebarCollapsed && <span className="ml-3">{localCode === 'vi' ? 'Quản lý mã giảm giá' : 'Coupons'}</span>}
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    title={localCode === 'vi' ? "Cài đặt hệ thống" : "System Settings"}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    {!isSidebarCollapsed && <span className="ml-3">{localCode === 'vi' ? 'Cài đặt hệ thống' : 'Settings'}</span>}
                  </Link>
                </li>
              </ul>
            </nav>
