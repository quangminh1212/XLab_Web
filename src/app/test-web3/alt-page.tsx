...
import { useSafeWeb3 } from '@/lib/use-safe-web3';

export default function AltTestWeb3Page() {
  const { web3, isReady, isLoading, error: web3Error } = useSafeWeb3();
  const [networkId, setNetworkId] = useState<string | null>(null);
  const [accounts, setAccounts] = useState<string[]>([]);
  const [error, setError] = useState<string | null>(web3Error?.message || null);
  ...
  return (
    <div className="container mx-auto py-10 px-4">
      <h1 className="text-3xl font-bold mb-6">Web3 Test Page (Alternate)</h1>
