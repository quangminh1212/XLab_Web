...
export async function GET(request: NextRequest) {
  try {
    ...
    // URL trong Google OAuth phải khớp với cấu hình trong Google Console
    const redirectUri = 'https://xlab-web.vercel.app/auth/google/callback';
    
    console.log("Google OAuth Callback - Đã nhận code:", code ? "Có" : "Không");
