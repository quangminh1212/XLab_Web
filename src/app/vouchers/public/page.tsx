          ...
          {filteredVouchers.map((voucher) => (
            ...
            >
              ...
              <div className="px-4 py-3 bg-gray-50 border-t border-gray-100 mt-auto">
                ...
                {activeTab === "used" && (
                  <div className="w-full py-2.5 px-4 rounded-md font-medium text-sm text-center text-orange-700 bg-orange-50">
                    Đã sử dụng hết số lần cho phép
                  </div>
                )}
                
                {activeTab === "expired" && (
                  <div className="w-full py-2.5 px-4 rounded-md font-medium text-sm text-center text-gray-500 bg-gray-100">
