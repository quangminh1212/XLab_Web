  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="mt-12 bg-teal-50 p-6 rounded-lg max-w-4xl mx-auto">
        ...
        <p className="mb-3">XLab cung cấp phương thức thanh toán an toàn và tiện lợi cho khách hàng:</p>
        ...
        <p className="text-sm text-gray-600">
          Mọi giao dịch đều được bảo mật theo tiêu chuẩn quốc tế. 
          Bạn có thể nạp tiền vào tài khoản và thanh toán ngay lập tức bằng số dư.
        </p>
      </div>
    </div>
  );
