      ...
      <section className="bg-primary-600 text-white py-16">
        <div className="container">
          ...
          <p className="text-xl max-w-3xl">
            Tìm câu trả lời nhanh chóng cho câu hỏi của bạn hoặc liên hệ với đội ngũ hỗ trợ của chúng tôi.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg text-center hover:shadow-md transition-shadow">
              ...
              <Link href="/support/documentation" className="text-primary-600 font-semibold hover:text-primary-700">
                Xem tài liệu
              </Link>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg text-center hover:shadow-md transition-shadow">
              ...
              <Link href="/support/contact" className="text-primary-600 font-semibold hover:text-primary-700">
                Liên hệ ngay
              </Link>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg text-center hover:shadow-md transition-shadow">
              ...
              <Link href="/community" className="text-primary-600 font-semibold hover:text-primary-700">
                Tham gia cộng đồng
              </Link>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <a href="mailto:support@xlab.vn" className="text-primary-600 font-semibold hover:text-primary-700">
                support@xlab.vn
              </a>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <a href="tel:19001234" className="text-primary-600 font-semibold hover:text-primary-700">
                1900-1234
              </a>
              ...
              <div key={item} className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-6">
                  <h3 className="font-bold text-lg mb-2">
                    Hướng dẫn sử dụng tính năng {item}
                  </h3>
                  <p className="text-gray-600 mb-4">
