      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-6">Thông tin bảo hành</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-white border border-gray-200 p-6 rounded-lg h-full">
                  <h3 className="text-xl font-semibold mb-4 text-gray-800">Chính sách bảo hành</h3>
                  <div className="space-y-4">
                    <div className="border-l-4 border-primary-500 pl-4 py-1">
                      <p className="text-gray-700">
                        <span className="font-medium">Thời gian bảo hành:</span> XLab cam kết bảo hành cho tất cả các tài khoản 
                        và phần mềm trong thời hạn <strong>365 ngày</strong> kể từ ngày mua.
                      </p>
                    </div>
                    
                    <div className="border-l-4 border-primary-500 pl-4 py-1">
                      <p className="text-gray-700">
                        <span className="font-medium">Quy trình bảo hành:</span> Khi tài khoản gặp sự cố, quý khách vui lòng gửi 
                        yêu cầu hỗ trợ thông qua form bên cạnh hoặc liên hệ trực tiếp qua Zalo, Email. Chúng tôi sẽ hỗ trợ 
                        kiểm tra và xử lý trong vòng 24 giờ làm việc.
                      </p>
                    </div>
  
                    <div className="border-l-4 border-primary-500 pl-4 py-1">
                      <p className="text-gray-700">
                        <span className="font-medium">Điều kiện bảo hành:</span> Tài khoản phải nằm trong thời hạn bảo hành và 
                        được sử dụng đúng quy định (không chia sẻ, cho mượn, hoặc sử dụng các công cụ không được phép).
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 p-6 rounded-lg h-full">
                  <h3 className="text-xl font-semibold mb-4 text-gray-800">Chính sách đổi trả</h3>
                  <div className="space-y-4">
                    <div className="border-l-4 border-green-500 pl-4 py-1">
                      <p className="text-gray-700">
                        <span className="font-medium">Thời gian đổi trả:</span> Trong vòng <strong>7 ngày</strong> kể từ ngày mua, 
                        quý khách có thể yêu cầu hoàn tiền nếu sản phẩm không đáp ứng được nhu cầu sử dụng.
                      </p>
                    </div>
                    
                    <div className="border-l-4 border-green-500 pl-4 py-1">
                      <p className="text-gray-700">
                        <span className="font-medium">Điều kiện đổi trả:</span> Sản phẩm chưa bị sửa đổi, can thiệp và không vi phạm 
                        các điều khoản sử dụng. XLab có quyền từ chối yêu cầu hoàn tiền nếu phát hiện dấu hiệu gian lận hoặc lạm dụng 
                        chính sách.
                      </p>
                    </div>
                    ...
                    <div className="border-l-4 border-green-500 pl-4 py-1">
                      <p className="text-gray-700">
                        <span className="font-medium">Quy trình hoàn tiền:</span> Sau khi xác nhận yêu cầu hợp lệ, chúng tôi sẽ
                        hoàn tiền qua phương thức thanh toán ban đầu trong vòng 3-5 ngày làm việc.
                      </p>
                    </div>
                  </div>
                </div>
