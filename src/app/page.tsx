            ...
            <section className="py-8 bg-gray-50">
              <div className="px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 auto-rows-fr">
                  <div className="bg-white p-5 rounded-lg shadow-sm flex flex-col h-full justify-between">
                  ...
                  <div className="bg-white p-5 rounded-lg shadow-sm flex flex-col h-full justify-between">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Làm thế nào để liên hệ hỗ trợ kỹ thuật?</h3>
                  ...
                  <div className="bg-white p-5 rounded-lg shadow-sm flex flex-col h-full justify-between">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">XLab có cung cấp giải pháp cho doanh nghiệp?</h3>
                ...
                <div className="text-center mt-8">
                  <Link href="/support" className="inline-flex items-center text-primary-600 hover:text-primary-800 font-medium">
                    Xem thêm câu hỏi
