            ...
            <section className="bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-2 p-2">
                <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-lg p-2 shadow-sm">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-0.5 text-xs">Sản phẩm trong nước</h3>
                  <p className="text-[10px] sm:text-xs text-gray-600">Phát triển bởi đội ngũ kỹ sư Việt Nam</p>
                </div>
                <div className="bg-gradient-to-br from-teal-50 to-blue-50 rounded-lg p-2 shadow-sm">
                  <div className="bg-white rounded-full w-6 h-6 flex items-center justify-center mb-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-teal-600">
                      <path d="M4.5 6.375a4.125 4.125 0 118.25 0 4.125 4.125 0 01-8.25 0zM14.25 8.625a3.375 3.375 0 116.75 0 3.375 3.375 0 01-6.75 0zM1.5 19.125a7.125 7.125 0 0114.25 0v.003l-.001.119a.75.75 0 01-.363.63 13.067 13.067 0 01-6.761 1.873c-2.472 0-4.786-.684-6.76-1.873a.75.75 0 01-.364-.63l-.001-.122zM17.25 19.128l-.001.144a2.25 2.25 0 01-.233.96 10.088 10.088 0 005.06-1.01.75.75 0 00.42-.643 4.875 4.875 0 00-6.957-4.611 8.586 8.586 0 011.71 5.157v.003z" />
                    </svg>
                  </div>
                  <h3 className="font-semibold text-gray-900 mb-0.5 text-xs">Hỗ trợ 24/7</h3>
                  <p className="text-[10px] sm:text-xs text-gray-600">Đội ngũ hỗ trợ tận tâm</p>
                </div>
                <div className="bg-gradient-to-br from-teal-50 to-blue-50 rounded-lg p-2 shadow-sm">
                  <div className="bg-white rounded-full w-6 h-6 flex items-center justify-center mb-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-teal-600">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-0.5 text-xs">Bảo mật cao</h3>
                  <p className="text-[10px] sm:text-xs text-gray-600">Dữ liệu được mã hóa an toàn</p>
                </div>
                <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-lg p-2 shadow-sm">
                  <div className="bg-white rounded-full w-6 h-6 flex items-center justify-center mb-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-teal-600">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-0.5 text-xs">Giá cả hợp lý</h3>
              ...
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-3 border border-gray-100 hover:shadow-md transition-all">
                  <div className="flex items-center mb-1.5">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900 text-xs">Nguyễn Văn A</h3>
                      <p className="text-[10px] text-gray-500">Giám đốc công nghệ</p>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg p-3 border border-gray-100 hover:shadow-md transition-all">
                  <div className="flex items-center mb-1.5">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900 text-xs">Trần Thị B</h3>
                      <p className="text-[10px] text-gray-500">Nhà thiết kế</p>
                    </div>
                  </div>
                  <div className="mb-1.5 flex">
                    {[1, 2, 3, 4, 5].map((star) => (
                ...
                <div className="bg-white rounded-lg p-3 border border-gray-100 hover:shadow-md transition-all">
                  <div className="flex items-center mb-1.5">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900 text-xs">Lê Văn C</h3>
                      <p className="text-[10px] text-gray-500">Sinh viên</p>
                    </div>
                  </div>
                  <div className="mb-1.5 flex">
                    {[1, 2, 3, 4, 5].map((star) => (
