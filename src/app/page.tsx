      ...
      <div className="container mx-auto py-responsive">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-responsive">
          ...
          <div className="w-full flex flex-col h-full md:col-span-1">
            ...
            {/* Thống kê, Continuous Updates và Ready to boost - 3 phần hàng ngang */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-3 mb-3">
              {/* Thống kê - Phần mới */}
              <section className="bg-white rounded-xl shadow-sm p-3 h-full">
                <h2 className="text-lg font-bold text-gray-800 mb-2">{t('home.achievements')}</h2>

                <div className="grid grid-cols-3 gap-2">
                  <div className="flex flex-col items-center text-center">
                    <div className="bg-primary-100 rounded-lg p-1.5 mb-1 inline-flex items-center justify-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                    ...
                    <div className="font-bold text-sm text-gray-900">10,000+</div>
                    <div className="text-[10px] text-gray-600">{t('home.customers')}</div>
                  </div>

                  <div className="flex flex-col items-center text-center">
                    <div className="bg-green-100 rounded-lg p-1.5 mb-1 inline-flex items-center justify-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                    ...
                    <div className="font-bold text-sm text-gray-900">30+</div>
                    <div className="text-[10px] text-gray-600">{t('home.softwareSolutions')}</div>
                  </div>

                  <div className="flex flex-col items-center text-center">
                    <div className="bg-blue-100 rounded-lg p-1.5 mb-1 inline-flex items-center justify-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                    ...
                    <div className="font-bold text-sm text-gray-900">5+</div>
                    <div className="text-[10px] text-gray-600">{t('home.yearsExperience')}</div>
                  </div>
                </div>
              </section>

              {/* Continuous Updates - Phần mới */}
              <section className="bg-white rounded-xl shadow-sm p-3 h-full">
                <h2 className="text-lg font-bold text-gray-800 mb-2">{t('home.continuousUpdates')}</h2>
                <div className="flex flex-col h-full">
                  <p className="text-xs text-gray-600 mb-2">
                    {t('home.newFeatures')}
                  </p>
                  <div className="flex items-center gap-2 mt-auto">
                    <div className="bg-blue-100 rounded-lg p-2 inline-flex items-center justify-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <span className="text-xs text-gray-700">
                      Luôn được cập nhật tính năng mới nhất
                    </span>
                  </div>
                </div>
              </section>
              ...
              <section className="bg-gradient-to-br from-primary-600 to-secondary-600 rounded-xl overflow-hidden p-3 text-white h-full flex flex-col">
                <h2 className="text-lg font-bold mb-1">{t('home.ctaTitle')}</h2>
                <p className="text-xs mb-auto text-white/90">
                  {t('home.ctaDesc')}
                </p>
                <Link
                  href="/contact"
                  className="bg-white text-primary-600 hover:bg-gray-100 text-xs font-medium py-1.5 px-3 rounded-lg transition-colors self-start mt-2"
                >
                  {t('home.contactUs')}
                </Link>
              </section>
