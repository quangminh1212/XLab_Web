              ...
              <div className="px-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
                  <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 hover:border-primary-100 hover:shadow-md transition-all flex flex-col h-full">
                    ...
                    <p className="text-gray-600">Bạn có thể tải xuống phần mềm miễn phí tại trang sản phẩm tương ứng sau khi đăng nhập vào tài khoản của mình. Đối với sản phẩm trả phí, bạn cần hoàn tất thanh toán trước khi tải xuống.</p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 hover:border-primary-100 hover:shadow-md transition-all flex flex-col h-full">
                    <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center">
                      <span className="text-primary-600 mr-2">
                    ...
                    <p className="text-gray-600">Sau khi mua sản phẩm, bạn sẽ nhận được mã kích hoạt qua email. Mở ứng dụng, vào phần "Kích hoạt bản quyền" và nhập mã này để sử dụng đầy đủ tính năng.</p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 hover:border-primary-100 hover:shadow-md transition-all flex flex-col h-full">
                    <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center">
                      <span className="text-primary-600 mr-2">
                    ...
                    <p className="text-gray-600">Mỗi bản quyền cho phép bạn sử dụng trên tối đa 3 thiết bị cùng một lúc. Bạn có thể quản lý danh sách thiết bị trong phần "Tài khoản" trên website.</p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 hover:border-primary-100 hover:shadow-md transition-all flex flex-col h-full">
                    <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center">
                      <span className="text-primary-600 mr-2">
                    ...
                    <p className="text-gray-600">Chúng tôi có chính sách hoàn tiền trong vòng 7 ngày kể từ ngày mua nếu sản phẩm không đáp ứng được nhu cầu của bạn. Liên hệ với bộ phận hỗ trợ để được hướng dẫn.</p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 hover:border-primary-100 hover:shadow-md transition-all flex flex-col h-full">
                    <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center">
                      <span className="text-primary-600 mr-2">
                    ...
                    <p className="text-gray-600">Bạn có thể liên hệ với đội ngũ hỗ trợ kỹ thuật thông qua email support@xlab.vn, hotline 1900.xxxx, hoặc chat trực tiếp trên website. Chúng tôi phản hồi trong vòng 24 giờ làm việc.</p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 hover:border-primary-100 hover:shadow-md transition-all flex flex-col h-full">
                    <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center">
                      <span className="text-primary-600 mr-2">
                    ...
                    <p className="text-gray-600">Có, chúng tôi có các gói dịch vụ đặc biệt dành cho doanh nghiệp với nhiều ưu đãi về giá và hỗ trợ kỹ thuật chuyên biệt. Liên hệ với chúng tôi để được tư vấn phương án phù hợp nhất.</p>
                  </div>
                </div>
