          ...
          <div className="w-full flex flex-col h-full md:col-span-1">
            ...
            <section className="bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto p-2 space-y-3 snap-y snap-mandatory">
                ...
                {/* Ready to boost - Converted to FeatureCard style */}
                <div className="snap-start bg-white border border-gray-100 hover:border-primary-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-all">
                  <div className="bg-primary-500 rounded-full w-12 h-12 flex items-center justify-center mb-3">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                  ...
                  <h3 className="font-bold text-gray-900 mb-2 text-base">{t('home.ctaTitle')}</h3>
                  <p className="text-sm text-gray-600 mb-3">{t('home.ctaDesc')}</p>
                  <Link
                    href="/contact"
                    className="bg-primary-500 text-white hover:bg-primary-600 text-xs font-medium py-1.5 px-3 rounded-lg transition-colors self-start inline-block"
                  >
                    {t('home.contactUs')}
                  </Link>
                </div>

                {/* Our Achievements - Converted to FeatureCard style */}
                <div className="snap-start bg-white border border-gray-100 hover:border-primary-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-all">
                  <div className="bg-amber-100 rounded-full w-12 h-12 flex items-center justify-center mb-3">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                    ...
                    >
                      <path fillRule="evenodd" d="M12 .75a.75.75 0 01.673.418l3.058 6.197 6.839.994a.75.75 0 01.415 1.279l-4.948 4.823 1.168 6.811a.75.75 0 01-1.088.791L12 18.347l-6.117 3.216a.75.75 0 01-1.088-.79l1.168-6.812-4.948-4.823a.75.75 0 01.416-1.28l6.838-.993L11.328 1.17A.75.75 0 0112 .75zm0 2.445L9.44 8.308a.75.75 0 01-.565.41l-5.725.832 4.143 4.038a.75.75 0 01.215.664l-.978 5.702 5.121-2.692a.75.75 0 01.698 0l5.12 2.692-.977-5.702a.75.75 0 01.215-.664l4.143-4.038-5.725-.831a.75.75 0 01-.565-.41L12 3.195z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <h3 className="font-bold text-gray-900 mb-2 text-base">{t('home.achievements')}</h3>
                  <div className="grid grid-cols-3 gap-2 mt-2">
                    <div className="flex flex-col items-center text-center">
                      ...
                      <div className="font-bold text-xs text-gray-900">10,000+</div>
                      <div className="text-xs text-gray-500">{t('home.customers')}</div>
                    </div>
                    ...
                    <div className="flex flex-col items-center text-center">
                      ...
                      <div className="font-bold text-xs text-gray-900">30+</div>
                      <div className="text-xs text-gray-500">{t('home.softwareSolutions')}</div>
                    </div>
                    ...
                    <div className="flex flex-col items-center text-center">
                      ...
                      <div className="font-bold text-xs text-gray-900">5+</div>
                      <div className="text-xs text-gray-500">{t('home.yearsExperience')}</div>
                    </div>
                  </div>
                </div>
              </div>
