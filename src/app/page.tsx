          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 transform transition-transform hover:scale-105">
                ...
                <p className="text-white/80">{t('home.customers')}</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 transform transition-transform hover:scale-105">
                ...
                <p className="text-white/80">{t('home.softwareSolutions')}</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 transform transition-transform hover:scale-105">
                ...
                <h3 className="font-bold text-2xl mb-1">5+</h3>
                <p className="text-white/80">{t('home.yearsExperience')}</p>
              </div>
            </div>
            
            {/* Thêm phần tính năng nổi bật */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl mx-auto mb-8">
              <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg p-4 text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/products"
                className="bg-primary-700 border border-white/30 hover:bg-primary-800 text-white font-medium py-3 px-6 rounded-lg transition-all shadow-lg hover:shadow-xl"
              >
