      ...
      <div className="container mx-auto py-responsive">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-responsive">
          ...
          <div className="md:col-span-4 h-full">
            {/* Thống kê - Phần mới - Dạng ngang (chuyển từ sidebar sang đây) */}
            <section className="bg-white rounded-xl shadow-sm p-6 mb-8">
              <h2 className="heading-3 text-gray-800 mb-6 text-center">{t('home.achievements')}</h2>

              <div className="grid grid-cols-3 gap-6">
                <div className="flex flex-col items-center text-center">
                  <div className="bg-primary-100 rounded-lg p-4 mb-3 inline-flex items-center justify-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                ...
                <div className="flex flex-col items-center text-center">
                  <div className="bg-green-100 rounded-lg p-4 mb-3 inline-flex items-center justify-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                  ...
                  <div className="text-sm text-gray-600">{t('home.softwareSolutions')}</div>
                </div>

                <div className="flex flex-col items-center text-center">
                  <div className="bg-blue-100 rounded-lg p-4 mb-3 inline-flex items-center justify-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
