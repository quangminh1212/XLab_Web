      ...
      <div className="container mx-auto py-responsive">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-responsive">
          ...
          <div className="w-full flex flex-col h-full md:col-span-1">
            ...
            {/* Chuyển đổi từ layout dọc sang layout ngang với 3 phần trong một dòng */}
            <section className="grid grid-cols-3 gap-3 mb-3">
              {/* Thống kê - Our Achievements */}
              ...
              {/* Ready to boost */}
              <div className="bg-gradient-to-br from-primary-600 to-secondary-600 rounded-xl overflow-hidden p-4 text-white">
                <div className="flex flex-col h-full justify-between">
                  <div>
                    <h2 className="text-lg font-bold mb-2">{t('home.ctaTitle')}</h2>
                  ...
                  <Link
                    href="/contact"
                    className="bg-white text-primary-600 hover:bg-gray-100 text-sm font-medium py-2 px-4 rounded-lg transition-colors self-start"
                  >
                    {t('home.contactUs')}
                  </Link>
                </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-4">
                <div className="flex flex-col h-full justify-between">
                  <div>
                    <div className="bg-primary-100 rounded-full w-12 h-12 flex items-center justify-center mb-3">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <h3 className="font-bold text-lg text-gray-900 mb-2">{t('home.continuousUpdates')}</h3>
