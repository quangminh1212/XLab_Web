        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
          <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="flex items-center">
                <div className="flex-1">
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-gray-600">(58 {t('testimonials.ratings')})</span>
                  </div>
                </div>
                
                <div className="ml-8 text-center px-6 py-4 bg-primary-50 rounded-lg">
                  <p className="text-gray-700 mb-4">{t('testimonials.satisfied')}</p>
            ...
            <div className="border-t border-gray-200 pt-8">
              <h3 className="text-lg font-medium mb-6">{t('testimonials.recent')}</h3>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div className="flex justify-between mb-2">
                    <div className="flex items-center">
                      <div className="w-10 h-10 rounded-full bg-primary-100 flex items-center justify-center">
                        <span className="text-primary-700 font-bold">NL</span>
                      </div>
                      <div className="ml-3">
                        <div className="font-medium">Nguyễn Linh</div>
                  ...
                  <p className="text-gray-700">
                    Phần mềm hoạt động tốt, tiết kiệm thời gian cho công việc. Tuy nhiên, giao diện có thể cải thiện thêm để trực quan hơn.
                    Hỗ trợ kỹ thuật phản hồi nhanh khi tôi gặp vấn đề.
                  </p>
                </div>
              </div>
            </div>
