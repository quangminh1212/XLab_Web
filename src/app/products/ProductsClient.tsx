...
import { useSearchParamsContext } from '@/components/ui/SearchParamsWrapper';
...
export default function ProductsClient() {
  ...
  const { getParam, getAllParams } = useSearchParamsContext();
  ...
  return (
    <div className="bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Sản phẩm phần mềm</h2>
