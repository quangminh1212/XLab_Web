...
export default function LoginPage() {
  ...
  // Định nghĩa URL đăng nhập Google trực tiếp
  const googleLoginUrl = "/api/auth/signin/google";

  return (
    <div className="container relative grid h-screen flex-col items-center justify-center py-4 lg:max-w-none lg:grid-cols-2 lg:px-0">
      <Link
        href="/register"
        className={cn(
      ...
      <div className="lg:p-8">
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
          ...
          <div className="grid gap-6">
            ...
            <a 
              href={googleLoginUrl}
              className="flex items-center justify-center gap-2 rounded-lg border border-input bg-background px-3 py-2 text-sm text-accent-foreground hover:bg-accent hover:text-accent-foreground"
            >
              <svg width="20" height="20" fill="currentColor" className="h-5 w-5" viewBox="0 0 48 48">
                <path
                  fill="#FFC107"
