...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (errorType) {
      ...
      switch (errorType) {
        case 'google':
          errorMessage = 'Đăng nhập bằng Google không thành công. Vui lòng thử lại hoặc sử dụng phương thức đăng nhập khác.';
          if (errorDesc) {
            errorMessage += ` Lỗi: ${errorDesc}`;
          }
          break;
        case 'credentials':
        ...
        case 'callback':
          ...
          break;
        default:
          errorMessage = `Lỗi đăng nhập: ${errorType}`;
      }
  ...
  // SVG của Google inline để tránh lỗi 404
  const GoogleIcon = () => (
