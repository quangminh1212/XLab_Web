      ...
      <div className="bg-white rounded-b-xl shadow-lg border border-gray-200">
        ...
        <div className="p-6">
          ...
          <div className="text-center mb-6">
            ...
            {/* QR Code thật từ VietQR - Phóng to hơn */}
          ...
          <div className="bg-primary-50 border border-primary-200 rounded-lg p-4 mb-6 max-w-md mx-auto">
            <h4 className="font-semibold text-primary-800 mb-3 flex items-center gap-2 justify-center">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm text-primary-700">Quét QR Code để chuyển khoản</span>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm text-primary-700">Nhập mã xác thực bên dưới</span>
              </div>
            </div>
          </div>

          {/* Form xác thực với màu XLab */}
          <div className="bg-secondary-50 border border-secondary-200 rounded-lg p-4 max-w-md mx-auto">
            <h4 className="font-semibold text-secondary-800 mb-3 flex items-center gap-2 justify-center">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
