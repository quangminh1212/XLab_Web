...
export default function FinalLanguageSwitcher({ className = '' }: { className?: string }) {
  ...
  // Effect to handle client-side mounting and click outside
  useEffect(() => {
    // Mark as mounted
    setMounted(true);
  ...
  // Don't render anything during SSR, just an empty placeholder
  if (!mounted) {
    return <div data-language-switcher-placeholder></div>;
  }
  
  // After client-side hydration, render the actual component
