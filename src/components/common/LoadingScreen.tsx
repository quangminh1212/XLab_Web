...
const LoadingScreen: React.FC<LoadingScreenProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/80 backdrop-blur-sm">
      <div className={`text-center p-4 sm:p-6 rounded-xl shadow-lg bg-white border border-gray-100 ${currentSize.container} w-full mx-4`}>
        ...
        <div className="mt-4 sm:mt-6 relative">
          <div className={`${currentSize.progress} w-full bg-gray-200 rounded-full overflow-hidden`}>
