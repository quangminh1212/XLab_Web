        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="space-y-2 text-left">
              <li>
                <Link href="/" className="hover:text-white text-sm transition-colors">Trang chủ</Link>
              </li>
              <li>
                <Link href="/products" className="hover:text-white text-sm transition-colors">Sản phẩm</Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/contact" className="hover:text-white text-sm transition-colors">Liên hệ</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="space-y-2 text-left">
              <li>
                <Link href="/products/xlab-office-suite" className="hover:text-white text-sm transition-colors">
                  XLab Office Suite
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-erp-system" className="hover:text-white text-sm transition-colors">
                  XLab ERP System
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-secure-vault" className="hover:text-white text-sm transition-colors">
                  XLab Secure Vault
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-design-master" className="hover:text-white text-sm transition-colors">
                  XLab Design Master
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-code-ide" className="hover:text-white text-sm transition-colors">
                  XLab Code IDE
                </Link>
              </li>
            </ul>
