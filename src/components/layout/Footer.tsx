  ...
  return (
    <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-slate-200 overflow-hidden">
      ...
      <div className="container mx-auto max-w-full md:max-w-[98%] xl:max-w-[1280px] 2xl:max-w-[1400px] px-4 sm:px-6 pt-6 sm:pt-8 md:pt-10 pb-8 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 lg:grid-cols-12 gap-x-3 sm:gap-x-4 md:gap-x-6 lg:gap-x-6 xl:gap-x-6 gap-y-6 sm:gap-y-8">
          {/* Column 1: Logo and Company Info */}
          <div className="sm:col-span-2 md:col-span-6 lg:col-span-6 xl:col-span-6 lg:pr-6">
            <div className="flex flex-col sm:flex-row sm:items-start gap-6 lg:gap-8 mb-6">
              <div className="flex-shrink-0 mb-4 self-center sm:mb-0 sm:self-start w-28 sm:w-32 md:w-44 lg:w-52 xl:w-56">
                ...
                <div className="flex justify-center sm:justify-center flex-wrap sm:flex-nowrap gap-2 sm:gap-3 mt-2">
                  <a
                    ...
                    className="group p-1.5 sm:p-2 rounded-lg bg-slate-800/40 hover:bg-blue-600/80 transition-colors duration-200 border border-slate-700/40"
                  >
                    <svg
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group p-1.5 sm:p-2 rounded-lg bg-slate-800/40 hover:bg-sky-500/80 transition-colors duration-200 border border-slate-700/40"
                  >
                    <svg
                      className="h-5 w-5 sm:h-6 sm:w-6 text-slate-400 group-hover:text-white transition-colors"
                      fill="currentColor"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group p-1.5 sm:p-2 rounded-lg bg-slate-800/40 hover:bg-blue-700/80 transition-colors duration-200 border border-slate-700/40"
                  >
                    <svg
                      className="h-5 w-5 sm:h-6 sm:w-6 text-slate-400 group-hover:text-white transition-colors"
                      fill="currentColor"
          ...
          <div className="flex flex-col items-center sm:items-start md:col-span-3 lg:col-span-3 xl:col-span-3 lg:border-l lg:border-slate-700/40 lg:px-6">
          ...
          <div className="flex flex-col items-center sm:items-start md:col-span-3 lg:col-span-3 xl:col-span-3 lg:border-l lg:border-slate-700/40 lg:pl-6">
            <h3 className="text-white text-lg sm:text-2xl font-bold mb-4 sm:mb-5 relative group">
            ...
            <ul className="flex flex-col items-start text-left mb-2 sm:mb-3 w-full gap-y-2">
              <li className="inline-flex items-center justify-start group min-w-0 w-full flex-none">
                ...
                <span className="flex-1 min-w-0 text-xs sm:text-sm text-slate-400 leading-relaxed truncate" title={t('footer.address')}>
                  {t('footer.address')}
                </span>
              </li>
              ...
              <li className="inline-flex items-center justify-start group min-w-0 w-full flex-none">
                ...
                <span className="flex-1 min-w-0 text-xs sm:text-sm text-slate-400 leading-relaxed truncate" title={t('footer.phone')}>
                  {t('footer.phone')}
                </span>
              </li>
              ...
              <li className="inline-flex items-center justify-start group min-w-0 basis-1/2 sm:basis-auto lg:w-full flex-none">
                ...
                <span className="flex-1 min-w-0 text-xs sm:text-sm text-slate-400 leading-relaxed truncate" title={t('footer.email')}>
                  {t('footer.email')}
                </span>
              </li>
              ...
              <li className="inline-flex items-center justify-start group min-w-0 basis-1/2 sm:basis-auto lg:w-full flex-none">
                ...
                <span className="flex-1 min-w-0 text-xs sm:text-sm text-slate-400 leading-relaxed truncate" title={t('footer.supportHours')}>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center space-y-3 lg:space-y-0 mt-8 sm:mt-12">
          ...
          <div className="flex flex-col sm:flex-col lg:flex-row items-center lg:items-start space-y-2 sm:space-y-2 lg:space-y-0 sm:space-x-0 lg:space-x-6 w-full lg:w-auto">
            <span className="text-xs sm:text-sm text-slate-400 font-medium w-full lg:w-auto text-center lg:text-left">
              {t('footer.acceptedPayments')}
            </span>
            <div className="flex items-center justify-center lg:justify-end flex-wrap space-x-1.5 sm:space-x-2.5 gap-y-2 w-full lg:w-auto">
              {/* Visa */}
