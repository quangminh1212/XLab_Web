      ...
      <div className="relative container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1 flex flex-col items-center lg:items-start">
            ...
            <p className="text-slate-400 mb-8 text-sm text-center lg:text-left leading-relaxed max-w-sm">
          ...
          <div className="flex flex-col items-center lg:items-start">
            <h3 className="text-white text-xl font-bold mb-6 relative group">
              <span className="relative z-10">Liên kết nhanh</span>
              <div className="absolute -bottom-2 left-1/2 lg:left-0 transform -translate-x-1/2 lg:translate-x-0 w-16 h-1 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-full transition-all duration-300 group-hover:w-20"></div>
            </h3>
            <ul className="space-y-3 text-center lg:text-left">
              <li>
                <Link href="/" className="group inline-flex items-center text-slate-400 hover:text-emerald-400 text-sm transition-all duration-300 hover:translate-x-2">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-emerald-400 rounded-full mr-0 group-hover:mr-3 transition-all duration-300"></span>
                  Trang chủ
                </Link>
              </li>
              <li>
                <Link href="/products" className="group inline-flex items-center text-slate-400 hover:text-emerald-400 text-sm transition-all duration-300 hover:translate-x-2">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-emerald-400 rounded-full mr-0 group-hover:mr-3 transition-all duration-300"></span>
                  Sản phẩm
                </Link>
              </li>
              <li>
                <Link href="/services" className="group inline-flex items-center text-slate-400 hover:text-emerald-400 text-sm transition-all duration-300 hover:translate-x-2">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-emerald-400 rounded-full mr-0 group-hover:mr-3 transition-all duration-300"></span>
                  Dịch vụ
                </Link>
              </li>
              <li>
                <Link href="/about" className="group inline-flex items-center text-slate-400 hover:text-emerald-400 text-sm transition-all duration-300 hover:translate-x-2">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-emerald-400 rounded-full mr-0 group-hover:mr-3 transition-all duration-300"></span>
                  Giới thiệu
                </Link>
              </li>
              <li>
                <Link href="/contact" className="group inline-flex items-center text-slate-400 hover:text-emerald-400 text-sm transition-all duration-300 hover:translate-x-2">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-emerald-400 rounded-full mr-0 group-hover:mr-3 transition-all duration-300"></span>
                  Liên hệ
                </Link>
              </li>
          ...
          <div className="flex flex-col items-center lg:items-start">
            <h3 className="text-white text-xl font-bold mb-6 relative group">
              ...
              <div className="absolute -bottom-2 left-1/2 lg:left-0 transform -translate-x-1/2 lg:translate-x-0 w-16 h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full transition-all duration-300 group-hover:w-20"></div>
            </h3>
            <ul className="space-y-3 text-center lg:text-left">
              <li>
                <Link href="/products/xlab-office-suite" className="group inline-flex items-center text-slate-400 hover:text-purple-400 text-sm transition-all duration-300 hover:translate-x-2">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-purple-400 rounded-full mr-0 group-hover:mr-3 transition-all duration-300"></span>
                  XLab Office Suite
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-erp-system" className="group inline-flex items-center text-slate-400 hover:text-purple-400 text-sm transition-all duration-300 hover:translate-x-2">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-purple-400 rounded-full mr-0 group-hover:mr-3 transition-all duration-300"></span>
                  XLab ERP System
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-secure-vault" className="group inline-flex items-center text-slate-400 hover:text-purple-400 text-sm transition-all duration-300 hover:translate-x-2">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-purple-400 rounded-full mr-0 group-hover:mr-3 transition-all duration-300"></span>
                  XLab Secure Vault
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-design-master" className="group inline-flex items-center text-slate-400 hover:text-purple-400 text-sm transition-all duration-300 hover:translate-x-2">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-purple-400 rounded-full mr-0 group-hover:mr-3 transition-all duration-300"></span>
                  XLab Design Master
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-code-ide" className="group inline-flex items-center text-slate-400 hover:text-purple-400 text-sm transition-all duration-300 hover:translate-x-2">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-purple-400 rounded-full mr-0 group-hover:mr-3 transition-all duration-300"></span>
                  XLab Code IDE
                </Link>
              </li>
          ...
          <div className="flex flex-col items-center lg:items-start">
            <h3 className="text-white text-xl font-bold mb-6 relative group">
              ...
              <div className="absolute -bottom-2 left-1/2 lg:left-0 transform -translate-x-1/2 lg:translate-x-0 w-16 h-1 bg-gradient-to-r from-orange-500 to-red-500 rounded-full transition-all duration-300 group-hover:w-20"></div>
            </h3>
            <ul className="space-y-4 text-center lg:text-left">
              <li className="flex items-start justify-center lg:justify-start group">
                <div className="p-2.5 rounded-xl bg-gradient-to-br from-orange-500/20 to-red-500/20 mr-3 group-hover:from-orange-500/30 group-hover:to-red-500/30 transition-all duration-300 border border-orange-500/20">
                ...
                <span className="text-sm text-slate-400 leading-relaxed max-w-[200px]">{siteConfig.contact.address}</span>
              </li>
              <li className="flex items-start justify-center lg:justify-start group">
                <div className="p-2.5 rounded-xl bg-gradient-to-br from-green-500/20 to-emerald-500/20 mr-3 group-hover:from-green-500/30 group-hover:to-emerald-500/30 transition-all duration-300 border border-green-500/20">
              ...
              <li className="flex items-start justify-center lg:justify-start group">
                <div className="p-2.5 rounded-xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 mr-3 group-hover:from-blue-500/30 group-hover:to-cyan-500/30 transition-all duration-300 border border-blue-500/20">
              ...
              <li className="flex items-start justify-center lg:justify-start group">
                <div className="p-2.5 rounded-xl bg-gradient-to-br from-violet-500/20 to-purple-500/20 mr-3 group-hover:from-violet-500/30 group-hover:to-purple-500/30 transition-all duration-300 border border-violet-500/20">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-8">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="group relative">
                <div className="w-12 h-8 bg-white/95 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300 border border-slate-200">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-9 h-6">
