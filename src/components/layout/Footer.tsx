...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      <div className="container max-w-[99.5%] mx-auto pt-12 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          {/* Logo và giới thiệu */}
          <div className="flex flex-col items-center md:items-start">
            <Link href="/" className="flex items-center justify-center md:justify-start mb-4">
              <span className="w-auto h-auto inline-flex items-center justify-center p-4 rounded-xl bg-white">
                <Image
                  src="/images/logo.jpg"
            ...
            <p className="text-gray-400 mb-5 text-base text-center md:text-left leading-relaxed">
            ...
            <div className="flex space-x-5">
              <a href={siteConfig.social.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary-300 transition-colors">
                <svg className="h-7 w-7" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                </svg>
              </a>
              <a href={siteConfig.social.twitter} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary-300 transition-colors">
                <svg className="h-7 w-7" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </a>
              <a href={siteConfig.social.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary-300 transition-colors">
                <svg className="h-7 w-7" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Liên kết nhanh */}
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-white text-lg font-semibold mb-5 relative pb-2 after:content-[''] after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:w-16 after:bg-primary-500 after:mx-auto md:after:mx-0">Liên kết nhanh</h3>
            <ul className="space-y-3 text-center md:text-left">
              <li>
                <Link href="/" className="hover:text-primary-300 text-base transition-colors">Trang chủ</Link>
              </li>
              <li>
                <Link href="/products" className="hover:text-primary-300 text-base transition-colors">Sản phẩm</Link>
              </li>
              <li>
                <Link href="/services" className="hover:text-primary-300 text-base transition-colors">Dịch vụ</Link>
              </li>
              <li>
                <Link href="/about" className="hover:text-primary-300 text-base transition-colors">Giới thiệu</Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-primary-300 text-base transition-colors">Liên hệ</Link>
              </li>
            </ul>
          </div>
          ...
          {/* Sản phẩm */}
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-white text-lg font-semibold mb-5 relative pb-2 after:content-[''] after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:w-16 after:bg-primary-500 after:mx-auto md:after:mx-0">Sản phẩm</h3>
            <ul className="space-y-3 text-center md:text-left">
              <li>
                <Link href="/products/xlab-office-suite" className="hover:text-primary-300 text-base transition-colors">
                  XLab Office Suite
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-erp-system" className="hover:text-primary-300 text-base transition-colors">
                  XLab ERP System
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-secure-vault" className="hover:text-primary-300 text-base transition-colors">
                  XLab Secure Vault
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-design-master" className="hover:text-primary-300 text-base transition-colors">
                  XLab Design Master
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-code-ide" className="hover:text-primary-300 text-base transition-colors">
                  XLab Code IDE
                </Link>
              </li>
            </ul>
          ...
          {/* Thông tin liên hệ */}
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-white text-lg font-semibold mb-5 relative pb-2 after:content-[''] after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:w-16 after:bg-primary-500 after:mx-auto md:after:mx-0">Liên hệ</h3>
            <ul className="space-y-3 text-center md:text-left">
              <li className="flex items-start justify-center md:justify-start">
                <svg className="h-6 w-6 text-primary-400 mt-0.5 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start justify-center md:justify-start">
                ...
                <span className="text-base">{siteConfig.contact.workingHours}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0 text-center md:text-left">
              <p className="text-base">&copy; {currentYear} {siteConfig.name}. Bản quyền thuộc về công ty {siteConfig.legal.companyName}.</p>
            </div>
            <div className="flex flex-col sm:flex-row items-center">
              ...
              <div className="flex space-x-4">
                ...
                {/* Bank Transfer */}
                <div className="w-12 h-8 bg-white rounded flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-7 h-6">
