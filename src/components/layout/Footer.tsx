  ...
  return (
    <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-slate-200 overflow-hidden">
      ...
      <div className="container mx-auto max-w-full md:max-w-[98%] xl:max-w-[1280px] 2xl:max-w-[1400px] px-4 sm:px-6 pt-6 sm:pt-8 md:pt-10 pb-8 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-12 gap-x-3 sm:gap-x-4 md:gap-x-6 lg:gap-x-6 xl:gap-x-6 gap-y-6 sm:gap-y-8">
          {/* Column 1: Logo and Company Info */}
          <div className="sm:col-span-2 md:col-span-2 lg:col-span-4 xl:col-span-4 lg:pr-6">
          ...
          <div className="flex flex-col items-center sm:items-start md:col-span-1 lg:col-span-4 xl:col-span-4 lg:border-l lg:border-slate-700/40 lg:px-6">
