      ...
      <div className="container mx-auto pt-10 pb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="mb-6 flex flex-col items-center">
            ...
            <p className="text-gray-400 mb-4 text-base text-left">
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="space-y-2 text-left">
              <li>
                <Link href="/" className="hover:text-white text-base transition-colors">Trang chủ</Link>
              </li>
              <li>
                <Link href="/products" className="hover:text-white text-base transition-colors">Sản phẩm</Link>
              </li>
              <li>
                <Link href="/services" className="hover:text-white text-base transition-colors">Dịch vụ</Link>
              </li>
              <li>
                <Link href="/about" className="hover:text-white text-base transition-colors">Giới thiệu</Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-white text-base transition-colors">Liên hệ</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="space-y-2 text-left">
              <li>
                <Link href="/products/xlab-office-suite" className="hover:text-white text-base transition-colors">
                  XLab Office Suite
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-erp-system" className="hover:text-white text-base transition-colors">
                  XLab ERP System
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-secure-vault" className="hover:text-white text-base transition-colors">
                  XLab Secure Vault
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-design-master" className="hover:text-white text-base transition-colors">
                  XLab Design Master
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-code-ide" className="hover:text-white text-base transition-colors">
                  XLab Code IDE
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-6 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col sm:flex-row items-center">
              <span className="text-sm text-gray-400 mb-2 sm:mb-0 sm:mr-3">Chấp nhận thanh toán</span>
              <div className="flex space-x-3">
                {/* Visa */}
                <div className="w-10 h-8 bg-white rounded flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-8 h-6">
