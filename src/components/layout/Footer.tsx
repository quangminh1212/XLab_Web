...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      <div className="container max-w-[99.5%] mx-auto pt-10 pb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="mb-8 flex flex-col items-center">
            ...
            <p className="text-gray-400 mb-4 text-sm text-left">
          ...
          <div className="flex flex-col items-start">
            <h3 className="text-white text-base font-semibold mb-3">Liên kết nhanh</h3>
            <ul className="space-y-2 text-left">
              <li>
                <Link href="/" className="hover:text-primary-300 text-sm transition-colors">Trang chủ</Link>
              </li>
              <li>
                <Link href="/products" className="hover:text-primary-300 text-sm transition-colors">Sản phẩm</Link>
              </li>
              <li>
                <Link href="/services" className="hover:text-primary-300 text-sm transition-colors">Dịch vụ</Link>
              </li>
              <li>
                <Link href="/about" className="hover:text-primary-300 text-sm transition-colors">Giới thiệu</Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-primary-300 text-sm transition-colors">Liên hệ</Link>
              </li>
            </ul>
          </div>
          ...
          {/* Sản phẩm */}
          <div className="flex flex-col items-start">
            <h3 className="text-white text-base font-semibold mb-3">Sản phẩm</h3>
            <ul className="space-y-2 text-left">
              <li>
                <Link href="/products/xlab-office-suite" className="hover:text-primary-300 text-sm transition-colors">
                  XLab Office Suite
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-erp-system" className="hover:text-primary-300 text-sm transition-colors">
                  XLab ERP System
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-secure-vault" className="hover:text-primary-300 text-sm transition-colors">
                  XLab Secure Vault
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-design-master" className="hover:text-primary-300 text-sm transition-colors">
                  XLab Design Master
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-code-ide" className="hover:text-primary-300 text-sm transition-colors">
                  XLab Code IDE
                </Link>
              </li>
            </ul>
          ...
          {/* Thông tin liên hệ */}
          <div className="flex flex-col items-start">
            <h3 className="text-white text-base font-semibold mb-3">Liên hệ</h3>
            <ul className="space-y-2 text-left">
              <li className="flex items-start">
                <svg className="h-5 w-5 text-primary-400 mt-0.5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start">
                ...
                <span className="text-sm">{siteConfig.contact.workingHours}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-6 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0 text-center md:text-left">
              <p className="text-sm">&copy; {currentYear} {siteConfig.name}. Bản quyền thuộc về công ty {siteConfig.legal.companyName}.</p>
            </div>
            <div className="flex flex-col sm:flex-row items-center">
              <span className="text-sm text-gray-400 mb-2 sm:mb-0 sm:mr-4">Chấp nhận thanh toán</span>
