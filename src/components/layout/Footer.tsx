        ...
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 mt-10 sm:mt-14">
          <div className="text-center sm:text-left">
            <p className="text-xs sm:text-sm text-slate-400">
              {`© ${CURRENT_YEAR} `}<span className="text-white font-medium">{siteConfig.name}</span>{`. ${COPYRIGHT_TEXT} `}<span className="text-primary-400">{siteConfig.legal.companyName}</span>
            </p>
          </div>
