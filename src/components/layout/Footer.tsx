        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center justify-center mb-6">
              <div className="relative p-6 rounded-2xl bg-gradient-to-br from-white via-gray-50 to-gray-100 shadow-xl">
                <Image
                  src="/images/logo.jpg"
            ...
            <div className="flex justify-center space-x-4">
              <a 
                ...
                className="group p-3 rounded-xl bg-gray-800/50 hover:bg-blue-600 transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-blue-500/25"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="group p-3 rounded-xl bg-gray-800/50 hover:bg-sky-500 transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-sky-500/25"
              >
                <svg className="h-5 w-5 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="group p-3 rounded-xl bg-gray-800/50 hover:bg-blue-700 transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-blue-700/25"
              >
                <svg className="h-5 w-5 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-4 text-center md:text-left">
              <li>
                <Link href="/products/xlab-office-suite" className="hover:text-primary-400 text-base transition-colors duration-300 hover:translate-x-1 inline-block">
                  XLab Office Suite
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-erp-system" className="hover:text-primary-400 text-base transition-colors duration-300 hover:translate-x-1 inline-block">
                  XLab ERP System
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-secure-vault" className="hover:text-primary-400 text-base transition-colors duration-300 hover:translate-x-1 inline-block">
                  XLab Secure Vault
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-design-master" className="hover:text-primary-400 text-base transition-colors duration-300 hover:translate-x-1 inline-block">
                  XLab Design Master
                </Link>
              </li>
              <li>
                <Link href="/products/xlab-code-ide" className="hover:text-primary-400 text-base transition-colors duration-300 hover:translate-x-1 inline-block">
                  XLab Code IDE
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-4 text-center md:text-left">
              <li className="flex items-start justify-center md:justify-start group">
                <div className="p-2 rounded-lg bg-primary-500/10 mr-3 group-hover:bg-primary-500/20 transition-colors">
                ...
                <span className="text-base leading-relaxed">{siteConfig.contact.address}</span>
              </li>
              <li className="flex items-start justify-center md:justify-start group">
                <div className="p-2 rounded-lg bg-primary-500/10 mr-3 group-hover:bg-primary-500/20 transition-colors">
                  <svg className="h-5 w-5 text-primary-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
          <div className="text-center lg:text-left">
            <p className="text-base text-gray-400">
              &copy; {currentYear} {siteConfig.name}. Bản quyền thuộc về công ty {siteConfig.legal.companyName}.
            </p>
          </div>
          
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-8">
            <span className="text-base text-gray-400 font-medium">Chấp nhận thanh toán</span>
            <div className="flex items-center space-x-3">
              {/* Visa */}
              <div className="group relative">
                <div className="w-14 h-9 bg-white rounded-lg flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-11 h-7">
              ...
              <div className="group relative">
                <div className="w-14 h-9 bg-white rounded-lg flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-8 h-7">
