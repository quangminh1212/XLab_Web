          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              {session ? (
                ...
                <button
                  onClick={() => signIn()}
                  className="bg-primary-500 hover:bg-primary-600 text-white px-4 py-2 rounded-lg text-base font-medium transition-colors"
                >
                  Đăng nhập
                </button>
              )}
              ...
              {isProfileOpen && session && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl py-2 z-10">
                  ...
                  <button
                    ...
                    className="block w-full text-left px-4 py-2 text-gray-700 hover:bg-gray-100 text-base"
                  >
                    Đăng xuất
                  </button>
                </div>
